...
class Zend_Reflection_ParameterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor() {
        ...
        $reflection1 = $factory->createParameter(array('Zend_Reflection_TestSampleClass2', 'getProp2'), 0);
        $this->assertType('Zend_Reflection_Parameter', $reflection1);

        $reflection2 = new Zend_Reflection_Parameter(array('Zend_Reflection_TestSampleClass2', 'getProp2'), 0);
        $this->assertType('Zend_Reflection_Parameter', $reflection2);
    ...
    {
        $factory = new Zend_Reflection_Factory();
        $parameter = $factory->createParameter(array('Zend_Reflection_TestSampleClass2', 'getProp2'), 0);
    ...
    {
        $factory = new Zend_Reflection_Factory();
        $parameter = $factory->createParameter(array('Zend_Reflection_TestSampleClass2', 'getProp2'), 'param2');
    ...
    {
        $factory = new Zend_Reflection_Factory();
        $parameter = $factory->createParameter(array('Zend_Reflection_TestSampleClass5', 'doSomething'), 'two');
