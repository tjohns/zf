...
class Manager
{
     ...
     */
    public function setStorage($name, StorageAdapterInterface $storage)
    {
    ...
    public function getStorage($name)
    {
        ...
        if (!isset($this->_storageTemplates[$name])) {
            throw new InvalidArgumentException("Storage template of name '$name' doesn't exist");
        }

        $storage = Cache::factory($this->_storageTemplates[$name]);
        $this->_storages[$name] = $storage;
