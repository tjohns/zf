...
class Zend_Tool_Rpc_Endpoint_Cli_Manifest implements Zend_Tool_Rpc_Manifest_Interface
{
    ...
    public function getMetadata()
    {
        ...
        foreach ($providerRegistry->getActions() as $action) {
            $metadatas[] = new Zend_Tool_Rpc_Manifest_ActionMetadata(array(
        ...
        foreach ($providerRegistry->getProviderSignatures() as $providerSignature) {
            ...
            $metadatas[] = new Zend_Tool_Rpc_Manifest_ProviderMetadata(array(
