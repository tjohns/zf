...
require_once 'Zend/Db/Adapter/Pdo/AbstractPdoTestCase.php';

PHPUnit_Util_Filter::addFileToFilter(__FILE__);

class Zend_Db_Adapter_PdoOciTest extends Zend_Db_Adapter_AbstractPdoTestCase
{
    ...
    public function testAdapterInsert()
    {
        ...
        $lastInsertId = $this->sharedFixture->dbAdapter->lastInsertId('zf_products', null); // implies 'products_seq'
