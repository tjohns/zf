...
class Zend_Db_Statement_PdoSqliteTest extends Zend_Db_Statement_AbstractPdoTestCase
{

    public function testStatementBindParamByName()
    {
        $this->markTestIncomplete($this->sharedFixture->dbUtility->getDriverName() . ' is having trouble with binding parameters');
    }
