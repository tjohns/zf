...
class Zend_Tool_Rpc_Endpoint_Cli_GetoptParser
{
    
    /**
     * @var Zend_Tool_Rpc_Endpoint_Cli
     */
    ...
    public function __construct(Zend_Tool_Rpc_Endpoint_Cli $endpoint, Array $arguments)
    {
    ...
    public function parse()
    {
        ...
        $cliActionableMethodLongParameterMetadata = Zend_Tool_Rpc_Manifest_Registry::getInstance()->getMetadata(array(
            'type'=>'Provider', 
        ...
        $cliActionableMethodShortParameterMetadata = Zend_Tool_Rpc_Manifest_Registry::getInstance()->getMetadata(array(
            'type'=>'Provider', 
            'providerName' => $provider->getName(), 
            'actionName' => $action->getName(), 
            'specialtyName' => $specialtyName, 
