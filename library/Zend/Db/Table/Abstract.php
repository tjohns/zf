...
abstract class Zend_Db_Table_Abstract
{
    ...
    public function insert(array $data)
    {
        ...
        if ($this->_sequence === true) {
             ...
             * or IDENTITY column.  Pass the table name and column name,
             * to support PostgreSQL implicit sequence names for SERIAL
             * columns.  True identity columns should ignore these args.
             */
            return $this->_db->lastInsertId($this->_name, $pk0);
        } 
