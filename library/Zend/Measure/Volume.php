...
class Zend_Measure_Volume extends Zend_Measure_Abstract
{
     ...
     * @param  string              $type    OPTIONAL A Zend_Measure_Volume Type
     ...
     *
     * @param  Zend_Measure_Volume  $object  Volume object to compare
     * @return boolean
     */
    ...
    public function setValue($value, $type = null, $locale = null)
    {
        ...
        if (empty( self::$_UNITS[$type] )) {
            throw new Zend_Measure_Exception("type ($type) is a unknown volume");
        }
