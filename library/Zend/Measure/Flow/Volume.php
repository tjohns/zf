...
class Zend_Measure_Flow_Volume extends Zend_Measure_Abstract
{
     ...
     * @param  string              $type    OPTIONAL A Zend_Measure_Flow_Volume Type
     ...
     *
     * @param  Zend_Measure_Flow_Volume  $object  Flow Volume object to compare
     * @return boolean
     */
    ...
    public function setValue($value, $type = null, $locale = null)
    {
        ...
        if (empty(self::$_UNITS[$type])) {
            throw new Zend_Measure_Exception("type ($type) is a unknown flow volume");
        }
