 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Barcode_Object_Code39 extends Zend_Barcode_Object
{
     ...
     * @var array
     */
    private $_codingMap = array('0' => '000110100' ,
            '1' => '100100001' ,
            '2' => '001100001' ,
            '3' => '101100000' ,
            '4' => '000110001' ,
    ...
    public function validateText($value)
    {
        if (preg_match("/[^0-9A-Z\-\. \*\$\/\+\?]/", $value)) {
            ...
            throw new Zend_Barcode_Object_Exception(
                    'Code39 just allow numerics, capital letters and "-. *$/+?" characters');
        }
    }
    ...
    {
        return (6 * $this->_barThinWidth + 3 * $this->_barThickWidth + 1) * $this->_factor;
    }
    ...
    protected function _calculateBarcodeWidth()
    {
        ...
        $encodedData = strlen($this->_text) * $this->_characterLength() - $this->_factor;
