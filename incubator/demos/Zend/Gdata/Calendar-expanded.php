 ...
 * @return void
 */
function outputCalendarList(Zend_Http_Client $client) 
{
    $gdataCal = new Zend_Gdata_Calendar($client);
 ...
 * @return void
 */
function outputCalendar(Zend_Http_Client $client) 
{
    $gdataCal = new Zend_Gdata_Calendar($client);
    $query = $gdataCal->newEventQuery();
 ...
 * @return void
 */
function outputCalendarByDateRange(Zend_Http_Client $client, $startDate='2007-05-01', 
                                   $endDate='2007-08-01') 
{
    $gdataCal = new Zend_Gdata_Calendar($client);
    $query = $gdataCal->newEventQuery();
 ...
 * @return string
 */
function createEvent (Zend_Http_Client $client, $title = 'Tennis with Beth', 
 ...
 * @return void
 */
function createRecurringEvent (Zend_Http_Client $client, $title = 'Tennis with Beth', 
                               $desc='Meet for a quick lesson', $where = 'On the courts', 
                               $recurData = null)
{
    $gc = new Zend_Gdata_Calendar($client);
 ...
 * @return Zend_Gdata_Calendar_EventEntry|null The updated entry
 */
function addExtendedProperty (Zend_Http_Client $client, $eventId, 
