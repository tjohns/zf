...
/**
 * ZendFramework_Sniffs_WhiteSpace_LanguageConstructSpacingSniff.
 *
 ...
 * @version    $Id: $
 */
class ZendFramework_Sniffs_WhiteSpace_LanguageConstructSpacingSniff implements PHP_CodeSniffer_Sniff
{
    /**
