...
/**
 * ZendFramework_Sniffs_Commenting_DocCommentAlignmentSniff
 *
 ...
 * @version    $Id: $
 */
class ZendFramework_Sniffs_Commenting_DocCommentAlignmentSniff implements PHP_CodeSniffer_Sniff
{
    /**
