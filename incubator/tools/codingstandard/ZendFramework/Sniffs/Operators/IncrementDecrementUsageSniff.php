...
/**
 * ZendFramework_Sniffs_Operators_IncrementDecrementUsageSniff.
 *
 ...
 * @version    $Id: $
 */
class ZendFramework_Sniffs_Operators_IncrementDecrementUsageSniff implements PHP_CodeSniffer_Sniff
{
    /**
