...
/**
 * ZendFramework_Sniffs_Formatting_MultipleStatementAlignmentSniff
 *
 ...
 * @version    $Id: $
 */
class ZendFramework_Sniffs_Formatting_MultipleStatementAlignmentSniff implements PHP_CodeSniffer_Sniff
{
