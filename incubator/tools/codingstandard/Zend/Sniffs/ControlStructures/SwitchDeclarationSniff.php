...
/**
 * ZendFramework_Sniffs_ControlStructures_SwitchDeclarationSniff.
 *
 ...
 * @version    $Id: $
 */
class ZendFramework_Sniffs_ControlStructures_SwitchDeclarationSniff implements PHP_CodeSniffer_Sniff
{
    /**
