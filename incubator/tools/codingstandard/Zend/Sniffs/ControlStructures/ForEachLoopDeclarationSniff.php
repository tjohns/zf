...
/**
 * ZendFramework_Sniffs_ControlStructures_ForEachLoopDeclarationSniff
 *
 ...
 * @version    $Id: $
 */
class ZendFramework_Sniffs_ControlStructures_ForEachLoopDeclarationSniff implements PHP_CodeSniffer_Sniff
{
    /**
