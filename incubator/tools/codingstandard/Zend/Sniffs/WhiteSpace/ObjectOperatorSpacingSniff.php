...
/**
 * Zend_Sniffs_WhiteSpace_ObjectOperatorSpacingSniff
 *
 * Ensure there is no whitespace before and after the object operator
 *
 * @category   Zend
 * @package    Zend_CodingStandard
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
 ...
 * @version    $Id: $
 */
class Zend_Sniffs_WhiteSpace_ObjectOperatorSpacingSniff implements PHP_CodeSniffer_Sniff
{
