 ...
 *
 */
class Zend_CardSpace_XmlParsing extends PHPUnit_Framework_TestCase
{
	...
	public function testEncryptedKey() {
		...
		$this->assertTrue($enckey->getKeyInfo() instanceof Zend_CardSpace_Xml_KeyInfo_Default);
	}

	public function testEncryptedKeyKeyInfo() {
		$keyinfo = Zend_CardSpace_Xml_EncryptedData::getInstance($this->_xmlDocument)->getKeyInfo()->getEncryptedKey()->getKeyInfo();
		
		$this->assertTrue($keyinfo instanceof Zend_CardSpace_Xml_KeyInfo_Default);
		$this->assertTrue($keyinfo->getSecurityTokenReference() instanceof Zend_CardSpace_Xml_SecurityTokenReference);
	}
	
	public function testSecurityTokenReference() {
		$sectoken = Zend_CardSpace_Xml_EncryptedData::getInstance($this->_xmlDocument)->getKeyInfo()
																					  ->getEncryptedKey()
																					  ->getKeyInfo()
																					  ->getSecurityTokenReference();
		$this->assertTrue($sectoken instanceof Zend_CardSpace_Xml_SecurityTokenReference);
