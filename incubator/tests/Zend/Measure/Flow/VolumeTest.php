 ...
 * @subpackage UnitTests
 */
class Zend_Measure_Flow_VolumeTest extends PHPUnit2_Framework_TestCase
{
    ...
    {
        $value = new Zend_Measure_Flow_Volume('-100',Zend_Measure_Flow_Volume::STANDARD,'de');
        $this->assertEquals($value->toString(), '-100 m³/sec', 'Value -100 m³/sec expected');
    }
    ...
    {
        $value = new Zend_Measure_Flow_Volume('-100',Zend_Measure_Flow_Volume::STANDARD,'de');
        $this->assertEquals($value->__toString(), '-100 m³/sec', 'Value -100 m³/sec expected');
    }
}
