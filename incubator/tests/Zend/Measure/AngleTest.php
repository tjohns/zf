 ...
 * @subpackage UnitTests
 */
class Zend_Measure_AngleTest extends PHPUnit2_Framework_TestCase
{
     ...
     * expected string
     */
    public function testAngleSerialize()
    {
        $value = new Zend_Measure_Angle('string -100.100,200',Zend_Measure_Angle::STANDARD,'de');
        $serial = $value->serialize();
        $this->assertTrue(!empty($serial),'Zend_Measure_Angle not serialized');
    }
     ...
     * expected object
     */
    public function testAngleUnSerialize()
    {
        $value = new Zend_Measure_Angle('string -100.100,200',Zend_Measure_Angle::STANDARD,'de');
        $serial = $value->serialize();
        $newvalue = unserialize($serial);
        $this->assertTrue($value->equals($newvalue),'Zend_Measure_Angle not unserialized');
    }
    ...
    {
        $value = new Zend_Measure_Angle('-100',Zend_Measure_Angle::GRAD,'de');
