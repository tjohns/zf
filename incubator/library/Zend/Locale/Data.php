...
class Zend_Locale_Data
{
    ...
    private static function _findRoute($locale, $path, $attribute, $value)
    {
        ...
        if (empty(self::$_ldml[$locale])) {
            if (!file_exists(dirname(__FILE__).'/Data/'.$locale.'.xml')) {
                ...
                throw new Zend_Locale_Exception('Missing locale for '.$locale);
            } 
     ...
     * 'language' - ISO 639    - http://www.unicode.org/reports/tr35/#ISO639
     *              Locale IDs - http://www.unicode.org/reports/tr35/#Locale_IDs
     * 'script'   - http://unicode.org/reports/tr24/
     *            - Script IDs - http://www.unicode.org/reports/tr35/#Scripts
     * 'territory'- ISO 3166   - http://www.unicode.org/reports/tr35/#ISO3166
     *              Locale IDs - http://www.unicode.org/reports/tr35/#Locale_IDs
     *            -            - http://www.unicode.org/reports/tr35/#UNM49
     * 'variant'  - Locale IDs - http://www.unicode.org/reports/tr35/#Locale_IDs
     * 'key'
     * 'type'
     * 'characters'
     *
    ...
    public static function getContent($locale, $path, $value)
    {
        ...
        switch(strtolower($path)) {
            ...
            case 'monthlist':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value[0].'\']/months/monthContext[@type=\'format\']/monthWidth[@type=\''.$value[1].'\']/month','type');
                break;
            ...
            case 'defdayformat':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/days/dayContext[@type=\'format\']/default','type','default');
                break;

            case 'daylist':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value[0].'\']/days/dayContext[@type=\'format\']/dayWidth[@type=\''.$value[1].'\']/day','type');
                break;

            case 'day':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value[0].'\']/days/dayContext[@type=\'format\']/dayWidth[@type=\''.$value[1].'\']/day[@type=\''.$value[2].'\']','type');
                break;

            case 'week':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/week/minDays','count','mindays');
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/week/firstDay','day','firstday');
                break;

            case 'weekend':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/week/weekendStart','day','startday');
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/week/weekendStart','time','starttime');
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/week/weekendEnd','day','endday');
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/week/weekendEnd','time','endtime');
                break;

            case 'daytime':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/am','','am');
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/pm','','pm');
                break;

            case 'erashortlist':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/eras/eraAbbr/era','type');
                break;
            ...
            case 'eralist':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/eras/eraNames/era','type');
                break;
            ...
            case 'defdateformat':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/dateFormats/default','type','default');
                break;

            case 'dateformat':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value[0].'\']/dateFormats/dateFormatLength[@type=\''.$value[1].'\']/dateFormat/pattern','','pattern');
                break;

            case 'deftimeformat':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/timeFormats/default','type','default');
                break;

            case 'timeformat':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value[0].'\']/timeFormats/timeFormatLength[@type=\''.$value[1].'\']/timeFormat/pattern','','pattern');
                break;

            case 'datetimeformat':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/dateTimeFormats/dateTimeFormatLength/dateTimeFormat/pattern','','pattern');
                break;

            case 'calendarfields':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/fields/field','type');
                $_temp = self::$_list;
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/fields/field[@type=\''.$key.'\']/displayName','',$key);
                } 
                break;

            case 'relativedates':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value.'\']/fields/relative','type');
                break;

            case 'relativedate':
                self::_getFile($locale, '/ldml/dates/calendars/calendar[@type=\''.$value[0].'\']/fields/relative[@type=\''.$value[1].'\']','type');
                break;
            ...
            case 'timezones':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile($locale, '/ldml/dates/timeZoneNames/zone[@type=\''.$key.'\']/exemplarCity','',$key);
                } 
                break;
            ...
            case 'timezonestandard':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile($locale, '/ldml/dates/timeZoneNames/zone[@type=\''.$key.'\']/long/standard','',$key);
                } 
                break;
            ...
            case 'timezonestandardshort':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile($locale, '/ldml/dates/timeZoneNames/zone[@type=\''.$key.'\']/short/standard','',$key);
                } 
                break;
            ...
            case 'timezonedaylight':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile($locale, '/ldml/dates/timeZoneNames/zone[@type=\''.$key.'\']/long/daylight','',$key);
                } 
                break;
            ...
            case 'timezonedaylightshort':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile($locale, '/ldml/dates/timeZoneNames/zone[@type=\''.$key.'\']/short/daylight','',$key);
                } 
                break;
            ...
            case 'timezoneformat':
                ...
                self::_getFile($locale, '/ldml/dates/timeZoneNames/abbreviationFallback','type','abbreviationfallback');
                self::_getFile($locale, '/ldml/dates/timeZoneNames/preferenceOrdering','type','preferenceOrdering');
                break;
            ...
            case 'decimalnumberformat':
                ...
                if (empty(self::$_list[0])) {
                    self::$_list = array();
                    self::_getFile($locale, '/ldml/numbers/decimalFormats/decimalFormatLength/decimalFormat/pattern','','default');
                } else {
                    $_temp = self::$_list;
                    self::$_list = array();
                    self::_getFile($locale, '/ldml/numbers/decimalFormats/default','type','default');
                    foreach ($_temp as $key => $found) {
                        self::_getFile($locale, '/ldml/numbers/decimalFormats/decimalFormatLength[@type=\''.$key.'\']/decimalFormat/pattern','',$key);
                    }
                } 
                break;
            ...
            case 'scientificnumberformat':
                ...
                if (empty(self::$_list[0])) {
                    self::$_list = array();
                    self::_getFile($locale, '/ldml/numbers/scientificFormats/scientificFormatLength/scientificFormat/pattern','','default');
                } else {
                    $_temp = self::$_list;
                    self::$_list = array();
                    self::_getFile($locale, '/ldml/numbers/scientificFormats/default','type','default');
                    foreach ($_temp as $key => $found) {
                        self::_getFile($locale, '/ldml/numbers/scientificFormats/scientificFormatLength[@type=\''.$key.'\']/scientificFormat/pattern','',$key);
                    }
                } 
                break;
            ...
            case 'percentnumberformat':
                ...
                if (empty(self::$_list[0])) {
                    self::$_list = array();
                    self::_getFile($locale, '/ldml/numbers/percentFormats/percentFormatLength/percentFormat/pattern','','default');
                } else {
                    $_temp = self::$_list;
                    self::$_list = array();
                    self::_getFile($locale, '/ldml/numbers/percentFormats/default','type','default');
                    foreach ($_temp as $key => $found) {
                        self::_getFile($locale, '/ldml/numbers/percentFormats/percentFormatLength[@type=\''.$key.'\']/percentFormat/pattern','',$key);
                    }
                } 
                break;
            ...
            case 'currencyformat':
                ...
                if (empty(self::$_list[0])) {
                    self::$_list = array();
                    self::_getFile($locale, '/ldml/numbers/currencyFormats/currencyFormatLength/currencyFormat/pattern','','default');
                } else {
                    $_temp = self::$_list;
                    self::$_list = array();
                    self::_getFile($locale, '/ldml/numbers/currencyFormats/default','type','default');
                    foreach ($_temp as $key => $found) {
                        self::_getFile($locale, '/ldml/numbers/currencyFormats/currencyFormatLength[@type=\''.$key.'\']/currencyFormat/pattern','',$key);
                    }
                } 
                self::_getFile($locale, '/ldml/numbers/currencyFormats/currencySpacing/beforeCurrency/currencyMatch','','beforMatch');
                self::_getFile($locale, '/ldml/numbers/currencyFormats/currencySpacing/beforeCurrency/surroundingMatch','','beforSurround');
                self::_getFile($locale, '/ldml/numbers/currencyFormats/currencySpacing/beforeCurrency/insertBetween','','beforBetween');
                self::_getFile($locale, '/ldml/numbers/currencyFormats/currencySpacing/afterCurrency/currencyMatch','','afterMatch');
                self::_getFile($locale, '/ldml/numbers/currencyFormats/currencySpacing/afterCurrency/surroundingMatch','','afterSurround');
                self::_getFile($locale, '/ldml/numbers/currencyFormats/currencySpacing/afterCurrency/insertBetween','','afterBetween');
                break;
            ...
            case 'currencynames':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile($locale, '/ldml/numbers/currencies/currency[@type=\''.$key.'\']/displayName','',$key);
                }
                break;
            ...
            case 'currencysymbols':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile($locale, '/ldml/numbers/currencies/currency[@type=\''.$key.'\']/symbol','',$key);
                }
                break;
            ...
            case 'currencyfraction':
                self::_getFile('supplementalData','/supplementalData/currencyData/fractions/info[@iso4217=\''.$value.'\']','digits','digits');
                self::_getFile('supplementalData','/supplementalData/currencyData/fractions/info[@iso4217=\''.$value.'\']','rounding','rounding');
                break;
            ...
            case 'currencydigitlist':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile('supplementalData','/supplementalData/currencyData/fractions/info[@iso4217=\''.$key.'\']','digits',$key);
                } 
                break;
            ...
            case 'currencyroundinglist':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile('supplementalData','/supplementalData/currencyData/fractions/info[@iso4217=\''.$key.'\']','rounding',$key);
                } 
                break;

            case 'currencyforregion':
                self::_getFile('supplementalData','/supplementalData/currencyData/region[@iso3166=\''.$value.'\']/currency','iso4217','currency');
                break;
            ...
            case 'currencyforregionlist':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile('supplementalData','/supplementalData/currencyData/region[@iso3166=\''.$key.'\']/currency','iso4217',$key);
                } 
                break;

            case 'regionforterritory':
                self::_getFile('supplementalData','/supplementalData/territoryContainment/group[@type=\''.$value.'\']','contains',$value);
                break;
            ...
            case 'regionforterritorylist':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile('supplementalData','/supplementalData/territoryContainment/group[@type=\''.$key.'\']','contains',$key);
                } 
                break;

            case 'scriptforlanguage':
                self::_getFile('supplementalData','/supplementalData/languageData/language[@type=\''.$value.'\']','scripts',$value);
                break;
            ...
            case 'scriptforlanguagelist':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile('supplementalData', '/supplementalData/languageData/language[@type=\''.$key.'\']','scripts',$key);
                } 
                break;

            case 'territoryforlanguage':
                self::_getFile('supplementalData','/supplementalData/languageData/language[@type=\''.$value.'\']','territories',$value);
                break;
            ...
            case 'territoryforlanguagelist':
                ...
                self::$_list = array();
                foreach ($_temp as $key => $found) {
                    self::_getFile('supplementalData', '/supplementalData/languageData/language[@type=\''.$key.'\']','territories',$key);
                } 
                break;
