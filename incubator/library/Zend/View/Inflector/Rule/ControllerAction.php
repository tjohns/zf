...
/**
 * View script inflection rule interface
 *
 * @package    Zend_View
 * @subpackage Inflector
 * @copyright  Copyright (c) 2005-2007 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_View_Inflector_Rule_ControllerAction implements Zend_View_Inflector_Rule_Interface
{
    /**
    ...
    public function inflect($path, array $params = array())
    {
        ...
        $replacements = array(
            ':controller' => str_replace($wordDelimiters, '-', strtolower(str_replace($this->_pathDelimiters, '/', $controller))),
