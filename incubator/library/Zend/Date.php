...
class Zend_Date extends Zend_Date_DateObject {
    ...
    {
        foreach(array('date','part') as $param) {
            $type = gettype($$param);
            if (($type === 'object' && ($$param instanceof Zend_Locale)) or
                ($type === 'string' && (Zend_Locale::isLocale($$param)))) {
                $locale = $$param;
                $restFalse = true;
            }
            if (isset($restFalse)) {
    ...
    private function _timestamp($calc, $stamp, $locale)
    {
        ...
        if (is_object($stamp)) {
            ...
            $stamp = parent::date('U', false, true);
        }
        // @todo: GMT = false
        $return = $this->_calcdetail($calc, $stamp, Zend_Date::TIMESTAMP, $locale);
        if ($calc != 'cmp') {
            $result = new Zend_Date(parent::getTimestamp(), Zend_Date::TIMESTAMP, $locale);
        ...
        for($i = 1; $i <= count($output); ++$i) {
            ...
            if ($notset == true) {
                ...
                if (($output[$i][0] !== "'") and (preg_match('/A+/', $output[$i]))) {
                    ...
                    $seconds   -= parent::mktime(0, 0, 0, $month, $day, $year, $this->_DST, $gmt);
    ...
    public function get($part = null, $locale = null)
    {
        ...
        switch($part) {
            ...
            // day formats
            case Zend_Date::DAY :
                return parent::date('d', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::WEEKDAY_SHORT :
                $weekday = strtolower(parent::date('D', parent::getTimestamp(), $gmt));
            ...
            case Zend_Date::DAY_SHORT :
                return parent::date('j', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::WEEKDAY_8601 :
                return parent::date('N', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::DAY_SUFFIX :
                return parent::date('S', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::WEEKDAY_DIGIT :
                return parent::date('w', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::DAY_OF_YEAR :
                return parent::date('z', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::MONTH_DAYS :
                return parent::date('t', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::LEAPYEAR :
                return parent::date('L', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::YEAR_8601 :
                return parent::date('o', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::YEAR :
                return parent::date('Y', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::YEAR_SHORT_8601 :
                $year = parent::date('o', parent::getTimestamp(), $gmt);
            ...
            case Zend_Date::MERIDIEM :
                $am = parent::date('a', parent::getTimestamp(), $gmt);
                $amlocal = Zend_Locale_Data::getContent($locale, 'daytime', 'gregorian');
                return $amlocal[$am];
                break;

            case Zend_Date::SWATCH :
                return parent::date('B', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::HOUR_SHORT_AM :
                return parent::date('g', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::HOUR_AM :
                return parent::date('h', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::MINUTE :
                return parent::date('i', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::TIMEZONE_NAME :
                return parent::date('e', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::GMT_DIFF_SEP :
                return parent::date('P', parent::getTimestamp(), $gmt);
                break;
            ...
            case Zend_Date::ISO_8601 :
                return parent::date('c', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::RFC_2822 :
                return parent::date('r', parent::getTimestamp(), $gmt);
                break;
            ...
            // additional formats
            case Zend_Date::ERA :
                $year = parent::date('Y', parent::getTimestamp(), $gmt);
                if ($year < 0) {
            ...
            case Zend_Date::ATOM :
                return parent::date('Y\-m\-d\TH\:i\:sP', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::COOKIE :
                return parent::date('l\, d\-M\-y H\:i\:s e', parent::getTimestamp(), $gmt);
                break;

            case Zend_Date::RFC_822 :
                return parent::date('D\, d M y H\:i\:s O', parent::getTimestamp(), $gmt);
                break;
            ...
            default :
                return parent::date($part, parent::getTimestamp(), $gmt);
                break;
        }
    }
    ...
    {
        $this->_setGmt(false);
        $result = $this->_calculate('copy', $this, $part, $locale);
        $this->_resetGmt();
        return $result;
    }
    ...
    private function _assign($calc, $date, $comp = 0)
    {
        switch ($calc) {
            case 'add' :
                parent::setTimestamp(call_user_func(Zend_Locale_Math::$add, parent::getTimestamp(), $date));
                return parent::getTimestamp();
                break;
            case 'sub' :
                parent::setTimestamp(call_user_func(Zend_Locale_Math::$sub, parent::getTimestamp(), $date));
                return parent::getTimestamp();
                break;
            case 'cmp' :
            ...
            case 'copy' :
                ...
                break;
            case 'set' :
                parent::setTimestamp(call_user_func(Zend_Locale_Math::$sub, parent::getTimestamp(), $comp));
                parent::setTimestamp(call_user_func(Zend_Locale_Math::$add, parent::getTimestamp(), $date));
                return parent::getTimestamp();
                break;
        }
     ...
     * @param  string|integer|Zend_Date  $date    Date or datepart to calculate with, if null the actual date is taken
    ...
    private function _calculate($calc, $date, $part, $locale)
    {
        ...
        if (is_object($date)) {
            ...
            $temp = new Zend_Date(parent::date('U', false, $this->_GMT), Zend_Date::TIMESTAMP, $locale);
        ...
        switch($part) {
            ...
            case Zend_Date::DAY :
                if (is_numeric($date)) {
                    return $this->_assign($calc, parent::mktime(0, 0, 0, 1, 1 + intval($date), 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, 0, 1, 1 + intval($day),  1970, $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::WEEKDAY_SHORT :
                ...
                // Weekday found
                if ($cnt < 7) {
                    return $this->_assign($calc, parent::mktime(0, 0, 0, 1, 1 + $found,   1970, $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, 0, 1, 1 + $weekday, 1970, $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::WEEKDAY_DIGIT :
                $weekday = (int) $this->get(Zend_Date::WEEKDAY_DIGIT, $locale);
                if ((intval($date) > 0) and (intval($date) < 8)) {
                    return $this->_assign($calc, parent::mktime(0, 0, 0, 1, 2 + $date,    1970, $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, 0, 1, 1 + $weekday, 1970, $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::DAY_OF_YEAR :
                if (is_numeric($date)) {
                    return $this->_assign($calc, parent::mktime(0, 0, 0, 1,      1 + $date, 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, 0, $month, 1 + $day,  1970, $this->_DST, $this->_GMT));
                }
                throw new Zend_Date_Exception("invalid date ($date) operand, day expected", $date);
                break;
            ...
            case Zend_Date::MONTH :
                ...
                if ($cnt < 12) {
                    ...
                    return $this->_assign($calc, parent::mktime(0, 0, 0, 1 + $found,   1, 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, 0, 1 + $monthnr, 1, 1970, $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::MONTH_SHORT :
                if (is_numeric($date)) {
                    ...
                    return $this->_assign($calc, parent::mktime(0, 0, 0, 1 + intval($date), 1, 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, 0, 1 + $month,        1, 1970, $this->_DST, $this->_GMT));
                }
                throw new Zend_Date_Exception("invalid date ($date) operand, month expected", $date);
                break;
            ...
            case Zend_Date::YEAR_8601 :
                if (is_numeric($date)) {
                    ...
                    return $this->_assign($calc, parent::mktime(0, 0, 0, 1, 1, 1970 + intval($date), $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, 0, 1, 1, 1970 + $year,         $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::YEAR_SHORT :
                if (is_numeric($date)) {
                    ...
                    if (($date >= 0) and ($date <= 100)) {
                        ...
                        return $this->_assign($calc, parent::mktime(0, 0, 0, 1, 1, 1970 + $date, $this->_DST, $this->_GMT),
                                                     parent::mktime(0, 0, 0, 1, 1, 1970 + $year, $this->_DST, $this->_GMT));
                    }
                }
                throw new Zend_Date_Exception("invalid date ($date) operand, year expected", $date);
            ...
            case Zend_Date::SWATCH :
                if (is_numeric($date)) {
                    ...
                    return $this->_assign($calc, parent::mktime($hours, $minutes, $seconds, 1, 1, 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime($hour,  $minute,  $second,  1, 1, 1970, $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::HOUR_SHORT_AM :
                if (is_numeric($date)) {
                    return $this->_assign($calc, parent::mktime(intval($date), 0, 0, 1, 1, 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime($hour,         0, 0, 1, 1, 1970, $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::MINUTE :
                if (is_numeric($date)) {
                    return $this->_assign($calc, parent::mktime(0, intval($date), 0, 1, 1, 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime(0, $minute,       0, 1, 1, 1970, $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::SECOND :
                if (is_numeric($date)) {
                    return $this->_assign($calc, parent::mktime(0, 0, intval($date), 1, 1, 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, $second,       1, 1, 1970, $this->_DST, $this->_GMT));
                }
            ...
            case Zend_Date::ISO_8601 :
                ...
                return $this->_assign($calc, parent::mktime($hours, $minutes, $seconds, 1 + $months, 1 + $days, 1970 + $years, $this->_DST, $this->_GMT),
                                             parent::mktime($hour,  $minute,  $second,  1 + $month,  1 + $day,  1970 + $year,  $this->_DST, $this->_GMT));
                break;
            ...
            case Zend_Date::TIMESTAMP :
                if (is_numeric($date)) {
                    return $this->_assign($calc, $date, parent::getTimestamp());
                }
            ...
            case Zend_Date::DATES :
                try {
                    ...
                    return $this->_assign($calc, parent::mktime(0, 0, 0, 1 + $parsed['month'],
                                                             1 + $parsed['day'], 1970 + $parsed['year'], $this->_DST, $this->_GMT),
                                                 parent::mktime(0, 0, 0, 1 + $month, 1 + $day, 1970 + $year, $this->_DST, $this->_GMT));
            ...
            case Zend_Date::TIMES :
                try {
                    ...
                    return $this->_assign($calc, parent::mktime($parsed['hour'], $parsed['minute'], $parsed['second'],
            ...
            case Zend_Date::TIME_FULL :
                try {
                    ...
                    return $this->_assign($calc, parent::mktime($parsed['hour'], $parsed['minute'], 0,
                                                             1, 1, 1970, $this->_DST, $this->_GMT),
                                                 parent::mktime($hour, $minute, $second, 1, 1, 1970, $this->_DST, $this->_GMT));
                } catch (Zend_Locale_Exception $e) {
                    throw new Zend_Date_Exception($e->getMessage(), $date);
    ...
    private function _time($calc, $time, $format, $locale)
    {
        ...
        if (is_object($time)) {
            ...
            if ($time === null) {
                $parsed['hour']   = parent::date('H', false, $this->_GMT);
                $parsed['minute'] = parent::date('i', false, $this->_GMT);
                $parsed['second'] = parent::date('s', false, $this->_GMT);
            } else {
     ...
     * @throws Zend_Date_Exception
     */
    public function setTime($time = null, $format = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function addTime($time = null, $format = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subTime($time = null, $format = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function compareTime($time = null, $format = null, $locale = null)
    {
    ...
    public function getDate($locale = null)
    {
        ...
        $date = new Zend_Date(0, Zend_Date::TIMESTAMP, $locale);
        $date->setGmt($this->_GMT);
        $date->set($result, Zend_Date::DATE_MEDIUM);
        return $date;
    }
    ...
    private function _date($calc, $date, $format, $locale)
    {
        ...
        if (is_object($date)) {
            ...
            if ($date === null) {
                $parsed['year']  = parent::date('Y', false, $this->_GMT);
                $parsed['month'] = parent::date('m', false, $this->_GMT);
                $parsed['day']   = parent::date('d', false, $this->_GMT);
            } else {
    ...
    private function _iso($calc, $iso, $locale)
    {
        ...
        if (is_object($iso)) {
            ...
            $iso = parent::date('c', false, $this->_GMT);
        }
        // @todo: GMT = true
     ...
     * @throws Zend_Date_Exception
     */
    public function setIso($date = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function addIso($date = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subIso($date = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function compareIso($date = null, $locale = null)
    {
    ...
    private function _arpa($calc, $arpa, $locale)
    {
        ...
        if (is_object($arpa)) {
            ...
            $arpa = parent::date('D\, d M y H\:m\:s O', false, $this->_GMT);
        }
        // @todo: GMT = true
     ...
     * @throws Zend_Date_Exception
     */
    public function setArpa($date = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function addArpa($date = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subArpa($date = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function compareArpa($date = null, $locale = null)
    {
     ...
     *
     * @param   string  $timezone  OPTIONAL timezone to set if null, the actual set systems timezone will be set
     * @return  string
     */
     ...
     *
     * @param  integer  $year  OPTIONAL year to check, if null the date objects year is checked
     * @return boolean
     */
    public function isLeapYear($year = null)
    {
        if ($year === null) {
            $year = (int) $this->get(Zend_Date::YEAR);
        }
    ...
    {
        $today = parent::date('Ymd');
        $day   = parent::date('Ymd',parent::getTimestamp());
        return ($today == $day);
    }
    ...
    private function _year($calc, $year, $locale)
    {
        ...
        if (is_object($year)) {
            ...
            $year = parent::date('Y', false, $this->_GMT);
     ...
     * @throws Zend_Date_Exception
     */
    public function setYear($year = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function addYear($year = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subYear($year = null, $locale = null)
    {
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|Zend_Date  $year    OPTIONAL Year to compare, if null the actual year is compared
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws Zend_Date_Exception
     */
    public function compareYear($year = null, $locale = null)
    {
    ...
    private function _month($calc, $month, $locale)
    {
        ...
        if (is_object($month)) {
            ...
            if ($month === null) {
                $found = parent::date('m', false, $this->_GMT);
            } else {
                if (is_numeric($month)) {
                    $found = $month;
                } else {
     ...
     * Returned is the new date object
     *
     * @param  string|integer|Zend_Date  $month   OPTIONAL Month to set, if null the actual month is set
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function setMonth($month = null, $locale = null)
    {
     ...
     * Returned is the new date object
     *
     * @param  string|integer|Zend_Date  $month   OPTIONAL Month to add, if null the actual month is added
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function addMonth($month = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subMonth($month = null, $locale = null)
    {
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|Zend_Date  $month   OPTIONAL Month to compare, if null the actual month is compared
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws Zend_Date_Exception
     */
     ...
     * @throws Zend_Date_Exception
     */
    public function setDay($day = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function addDay($day = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subDay($day = null, $locale = null)
    {
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|Zend_Date  $day     OPTIONAL Day to compare, if null the actual day is compared
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws Zend_Date_Exception
     */
    ...
    private function _weekday($calc, $weekday, $locale)
    {
        ...
        $this->_setGmt(false);
        if ($weekday === null) {
            $weekday = parent::date('w', false, $locale);
     ...
     * @throws Zend_Date_Exception
     */
    public function setWeekday($weekday = null, $locale = null)
    {
     ...
     * wednesday.
     *
     * @param  string|integer|Zend_Date  $month   OPTIONAL Weekday to add, if null the actual weekday is added
     * @param  boolean                   $gmt     OPTIONAL true = UTC time, false = actual time zone
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function addWeekday($weekday = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subWeekday($weekday = null, $locale = null)
    {
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|Zend_Date  $weekday  OPTIONAL Weekday to compare, if null the actual weekday is compared
     * @param  string|Zend_Locale        $locale   OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws Zend_Date_Exception
     */
    public function compareWeekday($weekday = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $day     OPTIONAL Day of Year to set, if null the actual day of year is set
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function setDayOfYear($day = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $day     OPTIONAL Day of Year to add, if null the actual day of year is added
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function addDayOfYear($day = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subDayOfYear($day = null, $locale = null)
    {
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|Zend_Date  $day     OPTIONAL Day of Year to compare, if null the actual day of year is compared
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws Zend_Date_Exception
     */
    public function compareDayOfYear($day = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $hour    OPTIONAL Hour to set, if null the actual hour is set
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function setHour($hour = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $hour    OPTIONAL Hour to add, if null the actual hour is added
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function addHour($hour = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subHour($hour = null, $locale = null)
    {
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|Zend_Date  $hour    OPTIONAL Hour to compare, if null the actual hour is compared
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws Zend_Date_Exception
     */
    public function compareHour($hour = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $minute  OPTIONAL Minute to set, if null the actual minute is set
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function setMinute($minute = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $minute  OPTIONAL Minute to add, if null the actual minute is added
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function addMinute($minute = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subMinute($minute = null, $locale = null)
    {
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|Zend_Date  $minute  OPTIONAL Hour to compare, if null the actual hour is compared
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws Zend_Date_Exception
     */
    public function compareMinute($minute = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $second  OPTIONAL Second to set, if null the actual second is set
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function setSecond($second = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $second  OPTIONAL Second to add, if null the actual second is added
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date  new date
     * @throws Zend_Date_Exception
     */
    public function addSecond($second = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subSecond($second = null, $locale = null)
    {
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|Zend_Date  $second  OPTIONAL Second to compare, if null the actual second is compared
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws Zend_Date_Exception
     */
    public function compareSecond($second = null, $locale = null)
    {
    ...
    private function _week($calc, $week, $locale)
    {
        ...
        if (is_object($week)) {
            ...
            $week = parent::date('W', false, $this->_GMT);
     ...
     *
     * @param  string|integer|Zend_Date  $week    OPTIONAL Week to set, when null the actual week is set
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date
     * @throws Zend_Date_Exception
     */
    public function setWeek($week = null, $locale = null)
    {
     ...
     *
     * @param  string|integer|Zend_Date  $week    OPTIONAL Week to add, when null the actual week is added
     * @param  string|Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return Zend_Date
     * @throws Zend_Date_Exception
     */
    public function addWeek($week = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function subWeek($week = null, $locale = null)
    {
     ...
     * @throws Zend_Date_Exception
     */
    public function compareWeek($week = null, $locale = null)
    {
