...
class Zend_Date {
    ...
    public function set($date, $part, $locale = false, $gmt = false)
    {
        ...
        switch($part) {
            ...
            // day formats
            case Zend_Date::DAY :
                $this->setTimestamp($this->_Date->mktime($hour, $minute, $second, 
                                                         $month, intval($date), $year, -1, $gmt));
            ...
            case Zend_Date::WEEKDAY_SHORT :
                ...
                if ($cnt < 7) {
                    ...
                    $this->setTimestamp($this->_Date->mktime($hour, $minute, $second, $month, 
                                                             $day + $difference, $year, - 1, $gmt));
                    return $this->getTimestamp();
                } else {
                    // Weekday not found
                    return false;
            ...
            case Zend_Date::DAY_OF_YEAR :
                $this->setTimestamp($this->_Date->mktime($hour, $minute, $second, 1, 
                                                         intval($date), $year, -1, $gmt));
                return $this->getTimestamp();
                break;
            ...
            case Zend_Date::MONTH :
                ...
                if ($cnt < 12) {
                    ...
                    $this->setTimestamp($this->_Date->mktime($hour, $minute, $second, 
                                                             $month + $difference, $day, $year, -1, $gmt));
                    return $this->getTimestamp();
                } else {
                    // Monthname not found
                    return false;
            ...
            case Zend_Date::MONTH_SHORT :
                $this->setTimestamp($this->_Date->mktime($hour, $minute, $second, intval($date), 
                                                         $day, $year, -1, $gmt));
                return $this->getTimestamp();
                break;
            ...
            case Zend_Date::MONTH_NAME :
                ...
                if ($cnt < 12) {
                    ...
                    $this->setTimestamp($this->_Date->mktime($hour, $minute, $second, $month + $difference,
                                                             $day, $year, -1, $gmt));
                    return $this->getTimestamp();
                } else {
                    // Monthname not found
            ...
            case Zend_Date::YEAR_8601 :
                $this->setTimestamp($this->_Date->mktime($hour, $minute, $second, $month, $day, 
                                                         intval($date), -1, $gmt));
                return $this->getTimestamp();
                break;
            ...
            case Zend_Date::HOUR_SHORT_AM :
                $this->setTimestamp($this->_Date->mktime(intval($date), $minute, $second, $month, $day, 
                                                         $year, -1, $gmt));
                return $this->getTimestamp();
                break;
            ...
            case Zend_Date::MINUTE :
                $this->setTimestamp($this->_Date->mktime($hour, intval($date), $second, $month, $day,
                                                         $year, -1, $gmt));
                return $this->getTimestamp();
                break;

            case Zend_Date::SECOND :
                $this->setTimestamp($this->_Date->mktime($hour, $minute, intval($date), $month, $day,
                                                         $year, -1, $gmt));
                return $this->getTimestamp();
                break;
    ...
    public function sub($date, $part, $locale = false, $gmt = false)
    {
        ...
        switch($part) {
            ...
            case Zend_Date::DATES :
                $parsed = Zend_Locale_Format::getDate($date, 'default', $locale);
                $this->subTimestamp($this->_Date->mktime(0, 0, 0, $parsed['month'], 
                                                         $parsed['day'], $parsed['year'], -1, $gmt));
                return $this->getTimestamp();
                break;
    ...
    public function cloneIt($part = '')
    {
        ...
        switch($part) {
            ...
            // day formats
            case Zend_Date::DAY :
                return new Zend_Date($this->_Date->mktime(0, 0, 0, 1, intval($day),  0, -1, $gmt));
                break;
            ...
            case Zend_Date::DAY_OF_YEAR :
                return new Zend_Date($this->_Date->mktime(0, 0, 0, $month, $day,  0, -1, $gmt));
                break;
            ...
            // week formats
            case Zend_Date::WEEK :
                return new Zend_Date($this->_Date->mktime(0, 0, 0, $month, intval($day),  0, -1, $gmt));
                break;


            // month formats
            case Zend_Date::MONTH :
                return new Zend_Date($this->_Date->mktime(0, 0, 0, $month, 1,  0, -1, $gmt));
                break;
            ...
            case Zend_Date::YEAR_8601 :
                return new Zend_Date($this->_Date->mktime(0, 0, 0, 1, 1,  $year, -1, $gmt));
                break;
            ...
            // time formats
            case Zend_Date::MERIDIEM :
                return new Zend_Date($this->_Date->mktime($hour, 0, 0, 1, 1, 0, -1, $gmt));
                break;

            case Zend_Date::SWATCH :
                return new Zend_Date($this->_Date->mktime($hour, $minute, $second, 1, 1, 0, -1, $gmt));
                break;
            ...
            case Zend_Date::MINUTE :
                return new Zend_Date($this->_Date->mktime(0, $minute, 0, 1, 1, 0, -1, $gmt));
                break;

            case Zend_Date::SECOND :
                return new Zend_Date($this->_Date->mktime(0, 0, $second, 1, 1, 0, -1, $gmt));
                break;
            ...
            // date strings
            case Zend_Date::ISO_8601 :
                return new Zend_Date($this->_Date->mktime($hour, $minute, $second, $month, $day, $year, -1, $gmt));
                break;
            ...
            case Zend_Date::DATES :
                return new Zend_Date($this->_Date->mktime(0, 0, 0, $month, $day, $year, -1, $gmt));
                break;
