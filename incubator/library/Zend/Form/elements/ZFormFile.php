...
class ZFormFile extends ZFormInputElement
{
     ...
     *
     * @param string id The optional identifier for the newly created ZFormFile
     * @param ZFormWebElement The optional parent of the newly create ZFormentryField.
     * The default value is null which means the ZFormFile is a root element.
     * @return     void
     */
    public function __construct($id = null, $parentNode = null)
    {
    	parent::__construct($id, $parentNode, 'FILE');
    }
