...
class Zend_Measure_Pressure extends Zend_Measure_Abstract
{
    ...
    private static $_UNITS = array(
        ...
        'Pressure::MICROBAR'              => array(0.1,        '�b'),
        'Pressure::MICROMETER_MERCURY_0C' => array(0.13332239, '�m mercury (0�C)'),
        'Pressure::MICROMETER_WATER_4C'   => array(0.00980665, '�m water (4�C)'),
        'Pressure::MICRON_MERCURY_0C'     => array(0.13332239, '� mercury (0�C)'),
        'Pressure::MICROPASCAL'           => array(0.000001,   '�Pa'),
