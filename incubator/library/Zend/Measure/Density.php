...
class Zend_Measure_Density extends Zend_Measure_Abstract
{
    ...
    private static $_UNITS = array(
        ...
        'Density::MICROGRAM_PER_CUBIC_CENTIMETER' => array(0.001,     '�g/cm�'),
        'Density::MICROGRAM_PER_CUBIC_DECIMETER'  => array(1.0e-6,    '�g/dm�'),
        'Density::MICROGRAM_PER_CUBIC_METER' => array(1.0e-9,         '�g/m�'),
        'Density::MICROGRAM_PER_LITER'       => array(1.0e-6,         '�g/l'),
        'Density::MICROGRAM_PER_MILLILITER'  => array(0.001,          '�g/ml'),
