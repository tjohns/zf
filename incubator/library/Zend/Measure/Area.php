...
class Zend_Measure_Area extends Zend_Measure_Abstract
{
    ...
    private static $_UNITS = array(
        ...
        'Area::SQUARE_BICRON'      => array(1.0e-24,          '���'),
        ...
        'Area::SQUARE_MICROINCH'   => array(array('' => 1.0e-6,'*' => 6.4516e-10), '�in�'),
        'Area::SQUARE_MICROMETER'  => array(1.0e-12,          '�m�'),
        'Area::SQUARE_MICROMICRON' => array(1.0e-24,          '���'),
        'Area::SQUARE_MICRON'      => array(1.0e-12,          '��'),
        ...
        'Area::SQUARE_MILLIMICRON' => array(1.0e-18,          'm��'),
