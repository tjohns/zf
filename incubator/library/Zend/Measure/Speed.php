...
class Zend_Measure_Speed extends Zend_Measure_Abstract
{
     ...
     * @param  string              $type    OPTIONAL A Zend_Measure_Speed Type
     ...
     *
     * @param  Zend_Measure_Speed  $object  Speed object to compare
     * @return boolean
     */
    ...
    public function setValue($value, $type = null, $locale = null)
    {
        ...
        if (empty(self::$_UNITS[$type])) {
            throw new Zend_Measure_Exception("type ($type) is a unknown speed");
        }
