...
class Zend_Measure_Speed extends Zend_Measure_Abstract
{
    ...
    private static $_UNITS = array(
        ...
        'Speed::CENTIMETER_PER_MINUTE'          => array(array('' => 0.01, '/' => 60),'cm/min'),
        'Speed::CENTIMETER_PER_SECOND'          => array(0.01,'cd/sec'),
        'Speed::DEKAMETER_PER_DAY'              => array(array('' => 10, '/' => 86400),'dam/day'),
        'Speed::DEKAMETER_PER_HOUR'             => array(array('' => 10, '/' => 3600),'dam/h'),
        'Speed::DEKAMETER_PER_MINUTE'           => array(array('' => 10, '/' => 60),'dam/min'),
        'Speed::DEKAMETER_PER_SECOND'           => array(10,'dam/sec'),
        'Speed::FOOT_PER_DAY'                   => array(array('' => 0.3048, '/' => 86400),'ft/day'),
        'Speed::FOOT_PER_HOUR'                  => array(array('' => 0.3048, '/' => 3600),'ft/h'),
        'Speed::FOOT_PER_MINUTE'                => array(array('' => 0.3048, '/' => 60),'ft/min'),
        'Speed::FOOT_PER_SECOND'                => array(0.3048,'ft/sec'),
        ...
        'Speed::FURLONG_PER_MINUTE'             => array(array('' => 201.1684, '/' => 60),'fur/min'),
        'Speed::FURLONG_PER_SECOND'             => array(201.1684,'fur/sec'),
        'Speed::HECTOMETER_PER_DAY'             => array(array('' => 100, '/' => 86400),'hm/day'),
        'Speed::HECTOMETER_PER_HOUR'            => array(array('' => 100, '/' => 3600),'hm/h'),
        'Speed::HECTOMETER_PER_MINUTE'          => array(array('' => 100, '/' => 60),'hm/min'),
        'Speed::HECTOMETER_PER_SECOND'          => array(100,'hm/sec'),
        'Speed::INCH_PER_DAY'                   => array(array('' => 0.0254, '/' => 86400),'in/day'),
        'Speed::INCH_PER_HOUR'                  => array(array('' => 0.0254, '/' => 3600),'in/h'),
        'Speed::INCH_PER_MINUTE'                => array(array('' => 0.0254, '/' => 60),'in/min'),
        'Speed::INCH_PER_SECOND'                => array(0.0254,'in/sec'),
        'Speed::KILOMETER_PER_DAY'              => array(array('' => 1000, '/' => 86400),'km/day'),
        'Speed::KILOMETER_PER_HOUR'             => array(array('' => 1000, '/' => 3600),'km/h'),
        'Speed::KILOMETER_PER_MINUTE'           => array(array('' => 1000, '/' => 60),'km/min'),
        'Speed::KILOMETER_PER_SECOND'           => array(1000,'km/sec'),
        ...
        'Speed::LEAGUE_PER_MINUTE'              => array(array('' => 4828.0417, '/' => 60),'league/min'),
        'Speed::LEAGUE_PER_SECOND'              => array(4828.0417,'league/sec'),
        ...
        'Speed::MEGAMETER_PER_MINUTE'           => array(array('' => 1000000, '/' => 60),'Mm/min'),
        'Speed::MEGAMETER_PER_SECOND'           => array(1000000,'Mm/sec'),
        'Speed::METER_PER_DAY'                  => array(array('' => 1, '/' => 86400),'m/day'),
        'Speed::METER_PER_HOUR'                 => array(array('' => 1, '/' => 3600),'m/h'),
        'Speed::METER_PER_MINUTE'               => array(array('' => 1, '/' => 60),'m/min'),
        ...
        'Speed::MILE_PER_MINUTE'                => array(array('' => 1609.344, '/' => 60),'mi/min'),
        'Speed::MILE_PER_SECOND'                => array(1609.344,'mi/sec'),
        'Speed::MILLIMETER_PER_DAY'             => array(array('' => 0.001, '/' => 86400),'mm/day'),
        'Speed::MILLIMETER_PER_HOUR'            => array(array('' => 0.001, '/' => 3600),'mm/h'),
        'Speed::MILLIMETER_PER_MINUTE'          => array(array('' => 0.001, '/' => 60),'mm/min'),
        'Speed::MILLIMETER_PER_SECOND'          => array(0.001,'mm/sec'),
        'Speed::MILLIMETER_PER_MICROSECOND'     => array(1000,'mm/µsec'),
        'Speed::MILLIMETER_PER_100_MICROSECOND' => array(10,'mm/100µsec'),
        'Speed::NAUTIC_MILE_PER_DAY'            => array(array('' => 1852, '/' => 86400),'nmi/day'),
        'Speed::NAUTIC_MILE_PER_HOUR'           => array(array('' => 1852, '/' => 3600),'nmi/h'),
        'Speed::NAUTIC_MILE_PER_MINUTE'         => array(array('' => 1852, '/' => 60),'nmi/min'),
        'Speed::NAUTIC_MILE_PER_SECOND'         => array(1852,'nmi/sec'),
        ...
        'Speed::YARD_PER_MINUTE'                => array(array('' => 0.9144, '/' => 60),'yd/min'),
        'Speed::YARD_PER_SECOND'                => array(0.9144,'yd/sec')
    );
