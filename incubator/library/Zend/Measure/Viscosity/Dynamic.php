...
class Zend_Measure_Viscosity_Dynamic extends Zend_Measure_Abstract
{
    ...
    private static $_UNITS = array(
        ...
        'Viscosity_Dynamic::DYNE_SECOND_PER_SQUARE_CENTIMETER'       => array(0.1,'dyn sec/cm²'),
        'Viscosity_Dynamic::GRAM_FORCE_SECOND_PER_SQUARE_CENTIMETER' => array(98.0665,'gf sec/cm²'),
        'Viscosity_Dynamic::GRAM_PER_CENTIMETER_SECOND'              => array(0.1,'g/cm sec'),
        'Viscosity_Dynamic::KILOGRAM_FORCE_SECOND_PER_SQUARE_METER'  => array(9.80665,'kgf sec/m²'),
        'Viscosity_Dynamic::KILOGRAM_PER_METER_HOUR'    => array(array('' => 1, '/' => 3600),'kg/m h'),
        'Viscosity_Dynamic::KILOGRAM_PER_METER_SECOND'  => array(1,'kg/m sec'),
        'Viscosity_Dynamic::MILLIPASCAL_SECOND'  => array(0.001,'mPa sec'),
        'Viscosity_Dynamic::MILLIPOISE'          => array(0.0001,'mP'),
        'Viscosity_Dynamic::NEWTON_SECOND_PER_SQUARE_METER' => array(1,'N sec/m²'),
        'Viscosity_Dynamic::PASCAL_SECOND'       => array(1,'Pa sec'),
        'Viscosity_Dynamic::POISE'               => array(0.1,'P'),
        'Viscosity_Dynamic::POISEUILLE'          => array(1,'Pl'),
        'Viscosity_Dynamic::POUND_FORCE_SECOND_PER_SQUARE_FEET' => array(47.880259,'lbf sec/ft²'),
        'Viscosity_Dynamic::POUND_FORCE_SECOND_PER_SQUARE_INCH' => array(6894.75729,'lbf sec/in²'),
        'Viscosity_Dynamic::POUND_PER_FOOT_HOUR' => array(0.00041337887,'lb/ft h'),
        'Viscosity_Dynamic::POUND_PER_FOOT_SECOND'          => array(1.4881639,'lb/ft sec'),
        'Viscosity_Dynamic::POUNDAL_HOUR_PER_SQUARE_FOOT'   => array(0.00041337887,'pdl h/ft²'),
        'Viscosity_Dynamic::POUNDAL_SECOND_PER_SQUARE_FOOT' => array(1.4881639,'pdl sec/ft²'),
        'Viscosity_Dynamic::REYN'                => array(6894.75729,'reyn'),
        'Viscosity_Dynamic::SLUG_PER_FOOT_SECOND'=> array(47.880259,'slug/ft sec'),
