...
class Zend_Measure_Viscosity_Kinematic extends Zend_Measure_Abstract
{
    ...
    private static $_UNITS = array(
        ...
        'Viscosity_Kinematic::LITER_PER_CENTIMETER_MINUTE'  => array(array('' => 1, '/' => 600),'l/cm min'),
        'Viscosity_Kinematic::LITER_PER_CENTIMETER_SECOND'  => array(0.1,'l/cm sec'),
        ...
        'Viscosity_Kinematic::SQUARE_CENTIMETER_PER_MINUTE' => array(array('' => 1, '/' => 600000),'cm²/min'),
        'Viscosity_Kinematic::SQUARE_CENTIMETER_PER_SECOND' => array(0.0001,'cm²/sec'),
        ...
        'Viscosity_Kinematic::SQUARE_FOOT_PER_MINUTE'       => array(0.001548384048,'ft²/min'),
        'Viscosity_Kinematic::SQUARE_FOOT_PER_SECOND'       => array(0.09290304,'ft²/sec'),
        ...
        'Viscosity_Kinematic::SQUARE_INCH_PER_MINUTE'       => array(0.000010752667,'in²/min'),
        'Viscosity_Kinematic::SQUARE_INCH_PER_SECOND'       => array(0.00064516,'in²/sec'),
        ...
        'Viscosity_Kinematic::SQUARE_METER_PER_MINUTE'      => array(array('' => 1, '/' => 60),'m²/min'),
        'Viscosity_Kinematic::SQUARE_METER_PER_SECOND'      => array(1,'m²/sec'),
        ...
        'Viscosity_Kinematic::SQUARE_MILLIMETER_PER_MINUTE' => array(array('' => 1, '/' => 60000000),'mm²/min'),
        'Viscosity_Kinematic::SQUARE_MILLIMETER_PER_SECOND' => array(0.000001,'mm²/sec'),
