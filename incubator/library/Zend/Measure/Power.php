...
class Zend_Measure_Power extends Zend_Measure_Abstract
{
    ...
    private static $_UNITS = array(
        ...
        'Power::BTU_PER_MINUTE'              => array(17.5843182,'BTU/min'),
        'Power::BTU_PER_SECOND'              => array(1055.059092,'BTU/sec'),
        'Power::CALORIE_PER_HOUR'            => array(array('' => 11630, '*' => 1.0e-7),'cal/h'),
        'Power::CALORIE_PER_MINUTE'          => array(array('' => 697800, '*' => 1.0e-7),'cal/min'),
        'Power::CALORIE_PER_SECOND'          => array(array('' => 41868000, '*' => 1.0e-7),'cal/sec'),
        ...
        'Power::DYNE_CENTIMETER_PER_MINUTE'  => array(array('' => 1.0e-7,'/' => 60),'dyn cm/min'),
        'Power::DYNE_CENTIMETER_PER_SECOND'  => array(1.0e-7,'dyn cm/sec'),
        'Power::ERG_PER_HOUR'                => array(array('' => 1.0e-7,'/' => 3600),'erg/h'),
        'Power::ERG_PER_MINUTE'              => array(array('' => 1.0e-7,'/' => 60),'erg/min'),
        'Power::ERG_PER_SECOND'              => array(1.0e-7,'erg/sec'),
        ...
        'Power::FOOT_POUND_FORCE_PER_MINUTE' => array(array('' => 1.3558179, '/' => 60),'ft lb/min'),
        'Power::FOOT_POUND_FORCE_PER_SECOND' => array(1.3558179,'ft lb/sec'),
        'Power::FOOT_POUNDAL_PER_HOUR'       => array(array('' => 0.04214011,'/' => 3600),'ft pdl/h'),
        'Power::FOOT_POUNDAL_PER_MINUTE'     => array(array('' => 0.04214011, '/' => 60),'ft pdl/min'),
        'Power::FOOT_POUNDAL_PER_SECOND'     => array(0.04214011,'ft pdl/sec'),
        'Power::GIGAWATT'                    => array(1.0e+9,'GW'),
        'Power::GRAM_FORCE_CENTIMETER_PER_HOUR' => array(array('' => 0.0000980665,'/' => 3600),'gf cm/h'),
        'Power::GRAM_FORCE_CENTIMETER_PER_MINUTE' => array(array('' => 0.0000980665,'/' => 60),'gf cm/min'),
        'Power::GRAM_FORCE_CENTIMETER_PER_SECOND' => array(0.0000980665,'gf cm/sec'),
        ...
        'Power::INCH_OUNCH_FORCE_REVOLUTION_PER_MINUTE' => array(0.00073948398,'in ocf/min'),
        'Power::JOULE_PER_HOUR'              => array(array('' => 1, '/' => 3600),'J/h'),
        'Power::JOULE_PER_MINUTE'            => array(array('' => 1, '/' => 60),'J/min'),
        'Power::JOULE_PER_SECOND'            => array(1,'J/sec'),
        'Power::KILOCALORIE_PER_HOUR'        => array(1.163,'kcal/h'),
        'Power::KILOCALORIE_PER_MINUTE'      => array(69.78,'kcal/min'),
        'Power::KILOCALORIE_PER_SECOND'      => array(4186.8,'kcal/sec'),
        'Power::KILOGRAM_FORCE_METER_PER_HOUR' => array(array('' => 9.80665, '/' => 3600),'kgf m/h'),
        'Power::KILOGRAM_FORCE_METER_PER_MINUTE' => array(array('' => 9.80665, '/' => 60),'kfg m/min'),
        'Power::KILOGRAM_FORCE_METER_PER_SECOND' => array(9.80665,'kfg m/sec'),
        'Power::KILOPOND_METER_PER_HOUR'     => array(array('' => 9.80665, '/' => 3600),'kp/h'),
        'Power::KILOPOND_METER_PER_MINUTE'   => array(array('' => 9.80665, '/' => 60),'kp/min'),
        'Power::KILOPOND_METER_PER_SECOND'   => array(9.80665,'kp/sec'),
        ...
        'Power::NEWTON_METER_PER_MINUTE'     => array(array('' => 1, '/' => 60),'Nm/min'),
        'Power::NEWTON_METER_PER_SECOND'     => array(1,'Nm/sec'),
