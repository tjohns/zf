...
class Zend_Measure_Flow_Volume extends Zend_Measure_Abstract
{
    ...
    private static $_UNITS = array(
        ...
        'Flow_Volume::ACRE_FOOT_PER_MINUTE'        => array(array('' => 1233.48184, '/' => 60),'ac ft/min'),
        'Flow_Volume::ACRE_FOOT_PER_SECOND'        => array(1233.48184,'ac ft/sec'),
        ...
        'Flow_Volume::ACRE_FOOT_SURVEY_PER_MINUTE' => array(array('' => 1233.48924, '/' => 60),'ac ft/min'),
        'Flow_Volume::ACRE_FOOT_SURVEY_PER_SECOND' => array(1233.48924,'ac ft/sec'),
        ...
        'Flow_Volume::ACRE_INCH_PER_MINUTE'        => array(array('' => 1233.48184, '/' => 720),'ac in/min'),
        'Flow_Volume::ACRE_INCH_PER_SECOND'        => array(array('' => 1233.48184, '/' => 12),'ac in/sec'),
        ...
        'Flow_Volume::ACRE_INCH_SURVEY_PER_MINUTE' => array(array('' => 1233.48924, '/' => 720),'ac in /min'),
        'Flow_Volume::ACRE_INCH_SURVEY_PER_SECOND' => array(array('' => 1233.48924, '/' => 12),'ac in/sec'),
        ...
        'Flow_Volume::BARREL_PETROLEUM_PER_MINUTE' => array(array('' => 0.1589872956, '/' => 60),'bbl/min'),
        'Flow_Volume::BARREL_PETROLEUM_PER_SECOND' => array(0.1589872956,'bbl/sec'),
        ...
        'Flow_Volume::BARREL_PER_MINUTE'           => array(array('' => 0.16365924, '/' => 60),'bbl/min'),
        'Flow_Volume::BARREL_PER_SECOND'           => array(0.16365924,'bbl/sec'),
        ...
        'Flow_Volume::BARREL_US_PER_MINUTE'        => array(array('' => 0.1192404717, '/' => 60),'bbl/min'),
        'Flow_Volume::BARREL_US_PER_SECOND'        => array(0.1192404717,'bbl/sec'),
        ...
        'Flow_Volume::BARREL_WINE_PER_MINUTE'      => array(array('' => 0.1173477658, '/' => 60),'bbl/min'),
        'Flow_Volume::BARREL_WINE_PER_SECOND'      => array(0.1173477658,'bbl/sec'),
        ...
        'Flow_Volume::BARREL_BEER_PER_MINUTE'      => array(array('' => 0.1173477658, '/' => 60),'bbl/min'),
        'Flow_Volume::BARREL_BEER_PER_SECOND'      => array(0.1173477658,'bbl/sec'),
        ...
        'Flow_Volume::BILLION_CUBIC_FOOT_PER_MINUTE' => array(array('' => 28316847, '/' => 60),'bn ft³/min'),
        'Flow_Volume::BILLION_CUBIC_FOOT_PER_SECOND' => array(28316847,'bn ft³/sec'),
        ...
        'Flow_Volume::CENTILITER_PER_MINUTE'       => array(array('' => 0.00001, '/' => 60),'cl/min'),
        'Flow_Volume::CENTILITER_PER_SECOND'       => array(0.00001,'cl/sec'),
        ...
        'Flow_Volume::CUBEM_PER_MINUTE'            => array(array('' => 4168181830, '/' => 60),'cubem/min'),
        'Flow_Volume::CUBEM_PER_SECOND'            => array(4168181830,'cubem/sec'),
        ...
        'Flow_Volume::CUBIC_CENTIMETER_PER_MINUTE' => array(array('' => 0.000001, '/' => 60),'cm³/min'),
        'Flow_Volume::CUBIC_CENTIMETER_PER_SECOND' => array(0.000001,'cm³/sec'),
        ...
        'Flow_Volume::CUBIC_DECIMETER_PER_MINUTE'  => array(array('' => 0.001, '/' => 60),'dm³/min'),
        'Flow_Volume::CUBIC_DECIMETER_PER_SECOND'  => array(0.001,'dm³/sec'),
        ...
        'Flow_Volume::CUBIC_DEKAMETER_PER_MINUTE'  => array(array('' => 1000, '/' => 60),'dam³/min'),
        'Flow_Volume::CUBIC_DEKAMETER_PER_SECOND'  => array(1000,'dam³/sec'),
        ...
        'Flow_Volume::CUBIC_FOOT_PER_MINUTE'       => array(array('' => 0.028316847, '/' => 60),'ft³/min'),
        'Flow_Volume::CUBIC_FOOT_PER_SECOND'       => array(0.028316847,'ft³/sec'),
        ...
        'Flow_Volume::CUBIC_INCH_PER_MINUTE'       => array(array('' => 0.028316847, '/' => 103680),'in³/min'),
        'Flow_Volume::CUBIC_INCH_PER_SECOND'       => array(0.028316847,'in³/sec'),
        ...
        'Flow_Volume::CUBIC_KILOMETER_PER_MINUTE'  => array(array('' => 1000000000, '/' => 60),'km³/min'),
        'Flow_Volume::CUBIC_KILOMETER_PER_SECOND'  => array(1000000000,'km³/sec'),
        'Flow_Volume::CUBIC_METER_PER_DAY'         => array(array('' => 1, '/' => 86400),'m³/day'),
        'Flow_Volume::CUBIC_METER_PER_HOUR'        => array(array('' => 1, '/' => 3600),'m³/h'),
        'Flow_Volume::CUBIC_METER_PER_MINUTE'      => array(array('' => 1, '/' => 60),'m³/min'),
        'Flow_Volume::CUBIC_METER_PER_SECOND'      => array(1,'m³/sec'),
        ...
        'Flow_Volume::CUBIC_MILE_PER_MINUTE'       => array(array('' => 4168181830, '/' => 60),'mi³/min'),
        'Flow_Volume::CUBIC_MILE_PER_SECOND'       => array(4168181830,'mi³/sec'),
        ...
        'Flow_Volume::CUBIC_MILLIMETER_PER_MINUTE' => array(array('' => 0.000000001, '/' => 60),'mm³/min'),
        'Flow_Volume::CUBIC_MILLIMETER_PER_SECOND' => array(0.000000001,'mm³/sec'),
        ...
        'Flow_Volume::CUBIC_YARD_PER_MINUTE'       => array(array('' => 0.764554869, '/' => 60),'yd³/min'),
        'Flow_Volume::CUBIC_YARD_PER_SECOND'       => array(0.764554869,'yd³/sec'),
        ...
        'Flow_Volume::DECILITER_PER_MINUTE'        => array(array('' => 0.0001, '/' => 60),'dl/min'),
        'Flow_Volume::DECILITER_PER_SECOND'        => array(0.0001,'dl/sec'),
        'Flow_Volume::DEKALITER_PER_DAY'           => array(array('' => 0.01, '/' => 86400),'dal/day'),
        'Flow_Volume::DEKALITER_PER_HOUR'          => array(array('' => 0.01, '/' => 3600),'dal/h'),
        'Flow_Volume::DEKALITER_PER_MINUTE'        => array(array('' => 0.01, '/' => 60),'dal/min'),
        'Flow_Volume::DEKALITER_PER_SECOND'        => array(0.01,'dal/sec'),
        ...
        'Flow_Volume::GALLON_PER_MINUTE'           => array(array('' => 0.00454609, '/' => 60),'gal/min'),
        'Flow_Volume::GALLON_PER_SECOND'           => array(0.00454609,'gal/sec'),
        ...
        'Flow_Volume::GALLON_US_PER_MINUTE'        => array(array('' => 0.0037854118, '/' => 60),'gal/min'),
        'Flow_Volume::GALLON_US_PER_SECOND'        => array(0.0037854118,'gal/sec'),
        ...
        'Flow_Volume::HECTARE_METER_PER_MINUTE'    => array(array('' => 10000, '/' => 60),'ha m/min'),
        'Flow_Volume::HECTARE_METER_PER_SECOND'    => array(10000,'ha m/sec'),
        'Flow_Volume::HECTOLITER_PER_DAY'          => array(array('' => 0.1, '/' => 86400),'hl/day'),
        'Flow_Volume::HECTOLITER_PER_HOUR'         => array(array('' => 0.1, '/' => 3600),'hl/h'),
        'Flow_Volume::HECTOLITER_PER_MINUTE'       => array(array('' => 0.1, '/' => 60),'hl/min'),
        'Flow_Volume::HECTOLITER_PER_SECOND'       => array(0.1,'hl/sec'),
        'Flow_Volume::KILOLITER_PER_DAY'           => array(array('' => 1, '/' => 86400),'kl/day'),
        'Flow_Volume::KILOLITER_PER_HOUR'          => array(array('' => 1, '/' => 3600),'kl/h'),
        'Flow_Volume::KILOLITER_PER_MINUTE'        => array(array('' => 1, '/' => 60),'kl/min'),
        'Flow_Volume::KILOLITER_PER_SECOND'        => array(1,'kl/sec'),
        ...
        'Flow_Volume::LAMBDA_PER_MINUTE'           => array(array('' => 0.000000001, '/' => 60),'lambda/min'),
        'Flow_Volume::LAMBDA_PER_SECOND'           => array(0.000000001,'lambda/sec'),
        'Flow_Volume::LITER_PER_DAY'               => array(array('' => 0.001, '/' => 86400),'l/day'),
        'Flow_Volume::LITER_PER_HOUR'              => array(array('' => 0.001, '/' => 3600),'l/h'),
        'Flow_Volume::LITER_PER_MINUTE'            => array(array('' => 0.001, '/' => 60),'l/min'),
        'Flow_Volume::LITER_PER_SECOND'            => array(0.001,'l/sec'),
        ...
        'Flow_Volume::MILLILITER_PER_MINUTE'       => array(array('' => 0.000001, '/' => 60),'ml/min'),
        'Flow_Volume::MILLILITER_PER_SECOND'       => array(0.000001,'ml/sec'),
        ...
        'Flow_Volume::MILLION_ACRE_FOOT_PER_MINUTE'  => array(array('' => 1233481840, '/' => 60),'million ac ft/min'),
        'Flow_Volume::MILLION_ACRE_FOOT_PER_SECOND'  => array(1233481840,'million ac ft/sec'),
        ...
        'Flow_Volume::MILLION_CUBIC_FOOT_PER_MINUTE' => array(array('' => 28316.847, '/' => 60),'million ft³/min'),
        'Flow_Volume::MILLION_CUBIC_FOOT_PER_SECOND' => array(28316.847,'million ft³/sec'),
        ...
        'Flow_Volume::MILLION_GALLON_PER_MINUTE'   => array(array('' => 4546.09, '/' => 60),'million gal/min'),
        'Flow_Volume::MILLION_GALLON_PER_SECOND'   => array(4546.09,'million gal/sec'),
        ...
        'Flow_Volume::MILLION_GALLON_US_PER_MINUTE'=> array(array('' => 3785.4118, '/' => 60),'million gal/min'),
        'Flow_Volume::MILLION_GALLON_US_PER_SECOND'=> array(3785.4118,'million gal/sec'),
        ...
        'Flow_Volume::OUNCE_PER_MINUTE'            => array(array('' => 0.00454609, '/' => 9600),'oz/min'),
        'Flow_Volume::OUNCE_PER_SECOND'            => array(array('' => 0.00454609, '/' => 160),'oz/sec'),
        ...
        'Flow_Volume::OUNCE_US_PER_MINUTE'         => array(array('' => 0.0037854118, '/' => 7680),'oz/min'),
        'Flow_Volume::OUNCE_US_PER_SECOND'         => array(array('' => 0.0037854118, '/' => 128),'oz/sec'),
        ...
        'Flow_Volume::PETROGRAD_STANDARD_PER_MINUTE' => array(array('' => 4.672279755, '/' => 60),'petrograd standard/min'),
        'Flow_Volume::PETROGRAD_STANDARD_PER_SECOND' => array(4.672279755,'petrograd standard/sec'),
        'Flow_Volume::STERE_PER_DAY'               => array(array('' => 1, '/' => 86400),'st/day'),
        'Flow_Volume::STERE_PER_HOUR'              => array(array('' => 1, '/' => 3600),'st/h'),
        'Flow_Volume::STERE_PER_MINUTE'            => array(array('' => 1, '/' => 60),'st/min'),
        'Flow_Volume::STERE_PER_SECOND'            => array(1,'st/sec'),
        ...
        'Flow_Volume::THOUSAND_CUBIC_FOOT_PER_MINUTE' => array(array('' => 28.316847, '/' => 60),'thousand ft³/min'),
        'Flow_Volume::THOUSAND_CUBIC_FOOT_PER_SECOND' => array(28.316847,'thousand ft³/sec'),
        ...
        'Flow_Volume::TRILLION_CUBIC_FOOT_PER_MINUTE' => array(array('' => 28316847000, '/' => 60),'trillion ft³/min'),
        'Flow_Volume::TRILLION_CUBIC_FOOT_PER_'       => array(28316847000,'trillion ft³/sec')
    );
    ...
    public function setValue($value, $type, $locale)
    {
        ...
        if (empty(self::$_UNITS[$type]))
            self::throwException('unknown type of flow-volume:'.$type);
