...
class Zend_Tool_Framework_Manifest_Registry //implements IteratorAggregate 
{
     ...
     *
     * @return Zend_Tool_Framework_Manifest_Registry
     */
            ...
            if (method_exists($manifest, 'getMetadata')) {
                ...
                foreach ($metadatas as $metadata) {
                    if (!$metadata instanceof Zend_Tool_Framework_Manifest_Metadata) {
                        throw new Zend_Tool_Framework_Manifest_Exception('A Zend_Tool_Framework_Manifest_Metadata object was not found in manifest ' . get_class($manifest));
                    }
