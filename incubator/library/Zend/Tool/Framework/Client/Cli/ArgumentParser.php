...
class Zend_Tool_Framework_Client_Cli_ArgumentParser
{
    ...
    protected function _parseProviderPart()
    {
        ...
        $cliSpecialtyMetadata = Zend_Tool_Framework_Manifest_Registry::getInstance()->getMetadata(array(
            'type' => 'Provider', 
    ...
    protected function _createHelpResponse(Array $options = array())
    {
        ...
        // action name is known, provider is not
            ...
            $providerMetadatas = $manifestRegistry->getMetadatas(array(
                'type' => 'Provider', 
        ...
        // provider name is known, action is not
            ...
            foreach ($validActions as $validAction) {
                $actionMetadata = $manifestRegistry->getMetadata(array(
                    'type' => 'Action',
                    'name' => 'cliActionName',
