...
class Zend_Tool_Project_Structure_Node implements RecursiveIterator, Countable
{
    ...
    public function __construct(Zend_Tool_Project_Structure_Context_Interface $context)
    {
        $this->setContext($context);
    }
    
    public function setContext(Zend_Tool_Project_Structure_Context_Interface $context)
    {
