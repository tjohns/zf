...
require_once 'Zend/Tool/Project/Structure/Context/Filesystem/File.php';

class Zend_Tool_Project_Structure_Context_Zf_ControllerFile extends Zend_Tool_Project_Structure_Context_Filesystem_File 
{
