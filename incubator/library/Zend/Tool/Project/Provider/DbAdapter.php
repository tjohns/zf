...
class Zend_Tool_Project_Provider_DbAdapter extends Zend_Tool_Project_Provider_Abstract
{
    ...
    public function configure($adapter = null, $parameters = null, $keyForConfig = 'database', $sectionForConfig = 'production')
    {
        ...
        $this->_getResponse()->appendContent('Writing configuration values to config file ' . $configPath);
        ...
        $this->_getResponse()->appendContent('Adding $dbAdapter to the bootstrap file at ' . $bootstrapFilePath);
    ...
    public function testConnection()
    {
        ...
        $this->_getResponse()->appendContent('Sending query "SELECT 1=1 as test"');
        $result = $dbAdapter->fetchAll('SELECT 1=1 as test');
        $this->_getResponse()->appendContent('Got result: ' . $result[0]['test']);
        $this->_getResponse()->appendContent('Db Connection appears to be working.');
