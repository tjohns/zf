...
class Zend_Controller_Action_Helper_ViewRenderer extends Zend_Controller_Action_Helper_Abstract
{
        ...
        foreach ($options as $key => $value)
        {
            switch ($key) {
                ...
                case 'viewBasePathSpec':
                    $this->setViewBasePathSpec($value);
                    break;
                case 'viewScriptPathSpec':
                    $this->setViewScriptPathSpec($value);
                    break;
                case 'viewScriptPathNoControllerSpec':
                    $this->setViewScriptPathNoControllerSpec($value);
                case 'viewSuffix':
                    $this->setViewSuffix($value);
                    break;
    ...
    {
        return $this->getInflector()->getRule('modulePath')->getPathSpec();
    }
