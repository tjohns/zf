...
class Zend_Auth_Adapter_Http implements Zend_Auth_Adapter_Interface
{
    ...
    /**
     * List of protected domains for Digest Auth
     */
    protected $_domains;
     ...
     *    'alogrithm' => <string> See $_supportedAlogs. Default: MD5
     ...
     *
     * @param Zend_Auth_Adapter_Http_Resolver_Interface
     * @return void
     * @throws none
     */
     ...
     *
     * @param string Client's Authorization header
     * @return Zend_Auth_Result
     * @throws Zend_Auth_Adapter_Exception
     */
    ...
    protected function _digestAuth($header)
    {
        ...
        switch ($data['qop']) {
            ...
            case 'auth-int':
                ...
                // but this isn't supported yet, so throw an exception
            default:
     ...
     *
     * @param string Client's Authorization: HTTP header
