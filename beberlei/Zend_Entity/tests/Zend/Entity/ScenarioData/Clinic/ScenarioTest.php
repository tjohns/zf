...
abstract class Zend_Entity_ScenarioData_Clinic_ScenarioTest extends Zend_Test_PHPUnit_DatabaseTestCase
{
    ...
    {
        $patient = $this->_entityManager->findByKey("Clinic_Patient", 1);
    ...
    public function testIdentityMapWorksAfterInsertAndThenRetrievalOfNewPatient()
    {
        ...
        $retrievedPatient = $this->_entityManager->findByKey("Clinic_Patient", $newPatientId);
    ...
    {
        $station = $this->_entityManager->findByKey("Clinic_Station", 1);
