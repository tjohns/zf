...
class Zend_Entity_Mapper_Definition_PrimaryKeyTest extends Zend_Entity_Mapper_Definition_TestCase
{
    public function testSetGetGenerator()
    {
        $idMock = $this->getMock('Zend_Entity_Mapper_Definition_Id_Interface');
    ...
    public function testApplyNextSequenceIdToDbState()
    {
        $sequenceId = 1;
        $primaryKeyDef = $this->createPrimaryKeyWithColumnAndIdGeneratorMock(self::MOCK_IDGEN_NEXTSEQUENCEID, $sequenceId);
        $entityDatabaseState = array();
        $dbMock = $this->getDatabaseAdapterMock();
        
        $entityDatabaseState = $primaryKeyDef->applyNextSequenceId($dbMock, $entityDatabaseState);
    ...
    {
        $sequenceId = 1;
        $primaryKeyDef = $this->createPrimaryKeyWithColumnAndIdGeneratorMock(self::MOCK_IDGEN_LASTSEQUENCEID, $sequenceId);
        $entityDatabaseState = array();
        $dbMock = $this->getDatabaseAdapterMock();
    ...
    public function createPrimaryKeyWithColumnAndIdGeneratorMock($mask, $sequenceId=1)
    {
        ...
        $idGeneratorMock = $this->getMock('Zend_Entity_Mapper_Definition_Id_Interface');
