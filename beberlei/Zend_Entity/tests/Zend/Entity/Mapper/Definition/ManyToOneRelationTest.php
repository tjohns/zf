...
class Zend_Entity_Mapper_Definition_ManyToOneRelationTest extends Zend_Entity_Mapper_Definition_RelationTest
{
    /**
    ...
    {
        return new Zend_Entity_Mapper_Definition_ManyToOneRelation(self::TEST_PROPERTY);
    }
