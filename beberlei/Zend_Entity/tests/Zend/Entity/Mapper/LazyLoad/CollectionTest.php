...
class Zend_Entity_Mapper_LazyLoad_CollectionTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $collection = new Zend_Entity_Mapper_LazyLoad_Collection('substr', array());
    ...
    public function testValidCallbackReturningNonCollectionThrowsException()
    {
        ...
        $callback = 'rand';
        $args = array(0, 1);
        $collection = new Zend_Entity_Mapper_LazyLoad_Collection($callback, $args);
        $collection->key();
    }
    ...
    public function createLazyLoadCollection($methodName, $returnValue=false)
    {
        ...
        return new Zend_Entity_Mapper_LazyLoad_Collection($callback, $args);
    }
