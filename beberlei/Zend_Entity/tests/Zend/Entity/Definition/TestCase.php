...
class Zend_Entity_Definition_TestCase extends PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMock('Zend_Entity_Definition_Entity');
    }
    ...
    {
        $propertyMock = $this->getMock('Zend_Entity_Definition_Property');
    ...
    /**
     * @param  string $name
     * @return Zend_Entity_Definition_Join
     */
    public function createJoinDefinition($name)
    {
        return new Zend_Entity_Definition_Join($name);
    }
}