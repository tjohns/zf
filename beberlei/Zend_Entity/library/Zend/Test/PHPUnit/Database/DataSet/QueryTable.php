...
class Zend_Test_PHPUnit_Database_DataSet_QueryTable extends PHPUnit_Extensions_Database_DataSet_QueryTable
{
    ...
    public function __construct($tableName, $query, PHPUnit_Extensions_Database_DB_IDatabaseConnection $databaseConnection)
    {
        if( !($databaseConnection instanceof Zend_Test_PHPUnit_Database_Connection) ) {
            ...
            throw new Zend_Test_PHPUnit_Database_Exception("Zend_Test_PHPUnit_Database_DataSet_QueryTable only works with Zend_Test_PHPUnit_Database_Connection connections-");
        }
