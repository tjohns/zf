 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Doctrine_Tool_DoctrineProvider extends Zend_Tool_Project_Provider_Abstract
    implements Zend_Tool_Framework_Provider_Pretendable
{

    /**
     * @var Zend_Doctrine_Registry
     */
    ...
    public function createProject($dsn, $withResourceDirectories = true)
    {
        ...
        $applicationConfigResource->addStringItem('pluginpaths.Zend_Doctrine_Application_Resource', 'Zend/Doctrine/Application/Resource', 'production');
        $applicationConfigResource->create();
    ...
    public function createTables()
    {
        ...
        try {
            $models = Zend_Doctrine_Core::getLoadedModels();
            $models = Zend_Doctrine_Core::filterInvalidModels($models);
    ...
    protected function _createImportSchema()
    {
        ...
        if ($modelLoading !== Zend_Doctrine_Core::MODEL_LOADING_ZEND) {
            ...
            $listener = new Zend_Doctrine_Tool_ResponseImportListener($response);
            $import = new Zend_Doctrine_Import_Schema();
