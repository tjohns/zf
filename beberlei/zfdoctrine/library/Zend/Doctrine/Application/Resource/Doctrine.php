 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Doctrine_Application_Resource_Doctrine extends Zend_Application_Resource_ResourceAbstract
{
    /**
     * @var array
     */
     ...
     *
     * @param   array $options
     * @return  Zend_Doctrine_Application_Resource_Doctrine
     */
    ...
    protected function _initManager()
    {
        ...
        $manager->setAttribute(Doctrine_Core::ATTR_MODEL_LOADING, Zend_Doctrine_Core::MODEL_LOADING_ZEND); // default
    ...
    public function init()
    {
        if (!class_exists('Doctrine_Core')) {
            throw Zend_Doctrine_DoctrineException::doctrineNotFound();
        }
        ...
        return new Zend_Doctrine_Registry($manager, $connections, $this->_paths, $this->_generateModelOptions);
    }
}
