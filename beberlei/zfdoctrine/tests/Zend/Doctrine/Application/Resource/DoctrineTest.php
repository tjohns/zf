...
class Zend_Doctrine_Application_Resource_DoctrineTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $options = array();
        $resource = new Zend_Doctrine_Application_Resource_Doctrine($options);
        $resource->setBootstrap($this->bootstrap);
        $doctrine = $resource->init();

        $this->assertType('Zend_Doctrine_Registry', $doctrine);
    }
