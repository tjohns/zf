...
class Zend_Entity_DbMapper_Persister_SimpleSaveTest extends Zend_Entity_TestCase
{
    ...
    public function testInsertNewEntity_WithVersion_SetsVersionField()
    {
        ...
        $this->assertEquals(0, $em->getIdentityMap()->getVersion($entity));
        $persister->doPerformSave($entity, $columnExpectedState, $em);
    ...
    public function testSaveEntity_WithRelatedLazyEntity_SavesForeignKey_IntoDb()
    {
        ...
        $identityMap = new Zend_Entity_IdentityMap();
        $identityMap->addObject('Zend_TestEntity2', $relatedId, $entityB);
        $em = $this->createTestingEntityManager(null, null, $identityMap);

        $persister = $this->createPersister();
        $actualDbState = $persister->transformEntityToDbState($entity->getState(), $em);
    ...
    public function testSaveEntity_WithRelatedProxyLazyEntity_SavesForeignKey_IntoDb()
    {
        $this->markTestIncomplete('implement pls!!!');
    }
    ...
    {
        $this->doTestSaveEntityWithCascade("persist");
    }
    ...
    {
        $this->doTestSaveEntityWithCascade("remove", false);
    }

    public function testSaveEntity_WithPersistCascadeNone()
    {
        $this->doTestSaveEntityWithCascade(array(), false);
    }
    ...
    public function testSaveEntity_WithRelatedCascading_OneToManyCollection()
    {
        ...
        $collectionDef->getRelation()->setCascade("persist");
     ...
     * @group dbtestadapter
     */
    public function testUpdateCollections_Array_DeleteRemovedElements()
    {
        $fixtureId = 1;
        $this->fixture = new Zend_Entity_Fixture_CollectionElementDefs();

        $elements = new Zend_Entity_Collection_Array(array("foo" => "bar"));
        unset($elements["foo"]);
    ...
    public function testUpdateCollections_Array_InsertAddedElements()
    {
        $fixtureId = 1;
        $this->fixture = new Zend_Entity_Fixture_CollectionElementDefs();
        ...
        $entityState = array('elements' => $arrayObject);
