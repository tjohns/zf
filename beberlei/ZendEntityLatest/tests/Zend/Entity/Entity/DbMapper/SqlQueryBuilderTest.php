...
class Zend_Entity_DbMapper_SqlQueryBuilderTest extends Zend_Entity_TestCase
{
    ...
    public function testWithForJoinTable_UseCorrelationToRefer_CreatesTwoRootEntitiesInResultSetMap()
    {
        ...
        $this->assertEquals(array(
                'Zend_TestEntity1' => 'Zend_TestEntity1',
                'Zend_TestEntity2' => 'Zend_TestEntity2'
            ), $rsm->rootEntity
        );
    }
    ...
    public function assertManyToOneFixture_JoinEntity_ResultSetMapping($rsm)
    {
        ...
        $this->assertEquals(array('Zend_TestEntity1' => 'Zend_TestEntity1'), $rsm->rootEntity);
        $this->assertEquals(
            array('Zend_TestEntity2' => array('parentAlias' => '', 'parentProperty' => '')),
            $rsm->joinedEntity
        );
    }
     ...
     */
    public function createNativeQueryBuilder($queryObject, $loader)
    {
    ...
    {
        $query = $this->createNativeQueryBuilder_WithLoader_ExpectingToProcessResultSet();
        $result = $query->getResultList();
    }

    public function testGetResultArray_DelegatesToLoader_ProcessResultset()
    {
        $query = $this->createNativeQueryBuilder_WithLoader_ExpectingToProcessResultSet();
        $result = $query->getResultArray();
    }

    public function testGetScalarResult_DelegatesToLoader_ProcessResultset()
    {
        $query = $this->createNativeQueryBuilder_WithLoader_ExpectingToProcessResultSet();
        $result = $query->getScalarResult();
    }

    public function testGetSingleScalar_DelegatesToLoader_ProcessResultset()
    {
        $query = $this->createNativeQueryBuilder_WithLoader_ExpectingToProcessResultSet();
        $result = $query->getSingleScalar();
    }

    public function createNativeQueryBuilder_WithLoader_ExpectingToProcessResultSet()
    {
        $fixtureReturnValue = "foo";

        $query = $this->createQueryObjectMock();
        $loader = $this->getLoaderMock();
        $this->addProcessResultsetExpectation($loader, $fixtureReturnValue);

        return $this->createNativeQueryBuilder($query, $loader);
    }

    public function addProcessResultsetExpectation($loader, $returnValue)
    {
    ...
    public function createQueryWithResultExpectation($fixtureReturnValue)
    {
        ...
        return $this->createNativeQueryBuilder($select, $loader);
    }
    ...
    public function createQueryObjectMock()
    {
        ...
        $dbAdapter->appendStatementToStack(new Zend_Test_DbStatement());
