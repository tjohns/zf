...
class Zend_Entity_Definition_EntityTest extends Zend_Entity_Definition_TestCase
{
     ...
     * @param string $expected
     */
    public function testSetAccess($accessStrategy, $expectedStateTransformerClass)
    {
        $entityDef = new Zend_Entity_Definition_Entity(self::TEST_CLASS);
        $entityDef->setAccess($accessStrategy);
        $this->assertEquals($expectedStateTransformerClass, $entityDef->getAccess());
    }

    public function tesProxyClassDefaultsToClassName()
    {
        $entityDef = new Zend_Entity_Definition_Entity(self::TEST_CLASS);
        $this->assertEquals(self::TEST_CLASS."Proxy", $entityDef->getProxyClass());
    }

    public function testSetProxyClass()
    {
        $entityDef = new Zend_Entity_Definition_Entity(self::TEST_CLASS);
        $entityDef->setProxyClass("Foo");
        $this->assertEquals("Foo", $entityDef->getProxyClass());
    }
    ...
    public function testVisitEntityDefinition()
    {
        ...
        $entityDef->visit($visitorMock, $this->getMock('Zend_Entity_MetadataFactory_FactoryAbstract'));
    }
