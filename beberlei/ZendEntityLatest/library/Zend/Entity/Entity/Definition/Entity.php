...
class Zend_Entity_Definition_Entity
{
     ...
     * @var string
     */
    const LAZYLOAD_GENERIC = 'generic';

    /**
     * @var string
     */
    const LAZYLOAD_PROXY = 'proxy';

    /**
     * @var string
     */
    const LAZYLOAD_DYNAMICPROXY = 'dynamicProxy';
    ...
    public function setClass($className)
    {
        ...
        if($this->proxyClass == null) {
            $this->proxyClass = $className."Proxy";
        }
    }
     ...
     */
    public function addPrimaryKey($propertyName, array $options=array())
    {
        return $this->add("PrimaryKey", $propertyName, $options);
    }
     ...
     */
    public function addProperty($propertyName, array $options=array())
    {
        return $this->add("Property", $propertyName, $options);
    }
     ...
     */
    public function addManyToOneRelation($propertyName, array $options=array())
    {
        return $this->add("ManyToOneRelation", $propertyName, $options);
    }
     ...
     */
    public function addOneToOneRelation($propertyName, array $options=array())
    {
        return $this->add("OneToOneRelation", $propertyName, $options);
    }
     ...
     */
    public function addCollection($propertyName, array $options=array())
    {
        return $this->add("Collection", $propertyName, $options);
    }
     ...
     */
    public function addVersion($propertyName, array $options=array())
    {
        return $this->add("Version", $propertyName, $options);
    }
     ...
     * @param string $propertyName
     * @param array $options
     * @return Zend_Entity_Definition_Array
     */
    public function addArray($propertyName, array $options=array())
    {
        return $this->add("Array", $propertyName, $options);
    }
     ...
     */
    public function visit(Zend_Entity_Definition_MappingVisitor $visitor, Zend_Entity_MetadataFactory_FactoryAbstract $metadataFactory)
    {
