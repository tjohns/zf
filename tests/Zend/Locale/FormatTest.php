...
class Zend_Locale_FormatTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testgetDate()
    {
        ...
        $this->assertEquals(count(Zend_Locale_Format::getDate('10.10.06', array('format' => 'dd.MM.yy'))), 5, "array with 5 tags expected");

        $value = Zend_Locale_Format::getDate('10.11.06', array('format' => 'dd.MM.yy'));
        ...
        $value = Zend_Locale_Format::getDate('10.11.2006', array('format' => 'dd.MM.yy'));
        ...
        try {
            $value = Zend_Locale_Format::getDate('2006.13.01', array('format' => 'dd.MM.yy'));
            $this->fail("no date expected");
        } catch (Zend_Locale_Exception $e) {
            $this->assertRegexp('/unable.to.parse/i', $e->getMessage());
            // success
        }
        $value = Zend_Locale_Format::getDate('2006.13.01', array('format' => 'dd.MM.yy', 'fixdate' => true));
        ...
        try {
            $value = Zend_Locale_Format::getDate('2006.01.13', array('format' => 'dd.MM.yy'));
            $this->fail("no date expected");
        } catch (Zend_Locale_Exception $e) {
            $this->assertRegexp('/unable.to.parse/i', $e->getMessage());
            // success
        }
        $value = Zend_Locale_Format::getDate('2006.01.13', array('format' => 'dd.MM.yy', 'fixdate' => true));
        $this->assertEquals($value['day'], 13, 'Day 13 expected');
        $this->assertEquals($value['month'], 1, 'Month 1 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');

        $value = Zend_Locale_Format::getDate('101106', array('format' => 'ddMMyy'));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 6, 'Year 6 expected');

        $value = Zend_Locale_Format::getDate('10112006', array('format' => 'ddMMyyyy'));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');

        $value = Zend_Locale_Format::getDate('10 Nov 2006', array('format' => 'dd.MMM.yy', 'locale' => 'de_AT'));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');

        $value = Zend_Locale_Format::getDate('10 November 2006', array('format' => 'dd.MMM.yy', 'locale' => 'de_AT'));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');

        try {
            $value = Zend_Locale_Format::getDate('November 10 2006', array('format' => 'dd.MMM.yy', 'locale' => 'de_AT'));
            $this->fail("no date expected");
        } catch (Zend_Locale_Exception $e) {
            $this->assertRegexp('/unable.to.parse/i', $e->getMessage());
            // success
        }
        $value = Zend_Locale_Format::getDate('November 10 2006', array('format' => 'dd.MMM.yy', 'locale' => 'de_AT', 'fixdate' => true));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');
        ...
        try {
            $value = Zend_Locale_Format::getDate('Nov 10 2006', array('format' => 'dd.MMM.yy', 'locale' => 'de_AT'));
            $this->fail("no date expected");
        } catch (Zend_Locale_Exception $e) {
            $this->assertRegexp('/unable.to.parse/i', $e->getMessage());
            // success
        }
        $value = Zend_Locale_Format::getDate('Nov 10 2006', array('format' => 'dd.MMM.yy', 'locale' => 'de_AT', 'fixdate' => true));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');
        ...
        try {
            $value = Zend_Locale_Format::getDate('2006 10 Nov', array('format' => 'dd.MMM.yy', 'locale' => 'de_AT'));
            $this->fail("no date expected");
        } catch (Zend_Locale_Exception $e) {
            $this->assertRegexp('/unable.to.parse/i', $e->getMessage());
            // success
        }
        $value = Zend_Locale_Format::getDate('2006 10 Nov', array('format' => 'dd.MMM.yy', 'locale' => 'de_AT', 'fixdate' => true));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');
...
//        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');
        ...
        $value = Zend_Locale_Format::getDate('10.11.06', array('format' => 'yy.dd.MM'));
        ...
        $value = Zend_Locale_Format::getDate('10.11.06', array('format' => 'dd.yy.MM'));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 6, 'Month 6 expected');
        ...
        $value = Zend_Locale_Format::getDate('01.April.2006', array('format' => 'dd.MMMM.yy', 'locale' => 'de_AT'));
        $this->assertEquals($value['day'], 1, 'Day 1 expected');
        $this->assertEquals($value['month'], 4, 'Month 4 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');

        $value = Zend_Locale_Format::getDate('Montag, 01.April.2006', array('format' => 'EEEE, dd.MMMM.yy', 'locale' => 'de_AT'));
        $this->assertEquals($value['day'], 1, 'Day 1 expected');
        $this->assertEquals($value['month'], 4, 'Month 4 expected');
        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');

        try {
            $value = Zend_Locale_Format::getDate('13.2006.11', array('format' => 'dd.MM.yy'));
            $this->fail();
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        ...
        $value = Zend_Locale_Format::getDate('10.11.06', array('format' => 'd.m.Y'));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 6, 'Year 6 expected');

        $value = Zend_Locale_Format::getDate('10.11.06', array('format' => 'd.m.Y', 'fixdate' => true));
        $this->assertEquals($value['day'], 10, 'Day 10 expected');
        $this->assertEquals($value['month'], 11, 'Month 11 expected');
        $this->assertEquals($value['year'], 6, 'Year 6 expected');
        
        $this->assertEquals(is_array(Zend_Locale_Format::getTime('13:14:55', array('format' => 'HH:mm:ss'))), true, "array expected");
...
//        $this->assertEquals($value['year'], 2006, 'Year 2006 expected');
    ...
    public function testgetTime()
    {
        ...
        $this->assertEquals(is_array(Zend_Locale_Format::getTime('13:14:55', array('format' => 'HH:mm:ss'))), true, "array expected");
        $options = array('format' => 'h:mm:ss a', 'locale' => 'en');
        ...
        try {
            $value = Zend_Locale_Format::getTime('13:14:55', array('format' => 'nocontent'));
            $this->fail("no time expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        ...
        try {
            $value = Zend_Locale_Format::getTime('13:14:55', array('format' => 'ZZZZ'));
            $this->fail("no time expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        ...
        try {
            $value = Zend_Locale_Format::getTime('13:14:55', array('format' => 'HH:mm:ss.x'));
            $this->fail("no time expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }

        $this->assertEquals(count(Zend_Locale_Format::getTime('13:14:55', array('format' => 'HH:mm:ss'))), 5, "array with 5 tags expected");

        $value = Zend_Locale_Format::getTime('13:14:55', array('format' => 'HH:mm:ss'));
        ...
        $value = Zend_Locale_Format::getTime('131455', array('format' => 'HH:mm:ss'));
        $this->assertEquals($value['hour'], 13, 'Hour 13 expected');
        $this->assertEquals($value['minute'], 14, 'Minute 14 expected');
        $this->assertEquals($value['second'], 55, 'Second 55 expected');
    }
    ...
    public function testIsDate()
    {
        ...
        $this->assertFalse(Zend_Locale_Format::isDate('20.01.2006', array('format' => 'M-d-y')), "false expected");
        $this->assertTrue(Zend_Locale_Format::isDate('20.01.2006', array('format' => 'd-M-y')), "true expected");
    }
    ...
    public function testToNumberFormat()
    {
        ...
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '##0', 'locale' => 'de_AT')), '1234567', "value 1234567 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '#,#0', 'locale' => 'de_AT')), '1.23.45.67', "value 1234567 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '##0.00', 'locale' => 'de_AT')), '1234567,12', "value 1234567 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '##0.###', 'locale' => 'de_AT')), '1234567,12345', "value 1234567 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '#,#0', 'locale' => 'de_AT')), '1.23.45.67', "value 1234567 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '#,##,##0', 'locale' => 'de_AT')), '12.34.567', "value 1234567 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '#,##0.00', 'locale' => 'de_AT')), '1.234.567,12', "value 1234567 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '#,#0.00', 'locale' => 'de_AT')), '1.23.45.67,12', "value 1234567 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(-1234567.12345, array('format' => '##0;##0-', 'locale' => 'de_AT')), '1234567-', "string -1.234.567,12345 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567.12345, array('format' => '##0;##0-', 'locale' => 'de_AT')), '1234567', "string -1.234.567,12345 expected");
        $this->assertEquals(Zend_Locale_Format::toNumberFormat(1234567, array('format' => '#,##0.00', 'locale' => 'de_AT')), '1.234.567,00', "value 1234567,00 expected");
    }
    ...
    {
        $this->assertTrue(Zend_Locale_Format::setOptions(array('type' => 'php')));
