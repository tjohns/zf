...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Zend_Application_Resource_BaseTest::main');
}
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Application_Resource_BaseTest extends PHPUnit_Framework_TestCase
{
...
if (PHPUnit_MAIN_METHOD == 'Zend_Application_Resource_BaseTest::main') {
    Zend_Application_Resource_BaseTest::main();
}
