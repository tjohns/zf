...
/** Zend_Controller_Page */
require_once 'Zend/Controller/Page.php';
...
{
    /**
     * Directory where Zend_Controller_Page files are stored.
     * @var string
     */
     ...
     * Zend_Controller_Page would use.
     *
     ...
     * inside a class extending Zend_Controller_Page.
     *
     * @param string $unformatted
     * @return string
     */
    ...
    /**
     * Sets the directory where the Zend_Controller_Page class files are stored.
     *
     * @param string $dir
     */
     ...
     * This only verifies that the Zend_Controller_Page can be dispatched and does not
     * guarantee that the action will be accepted by the Zend_Controller_Page.
     *
	...
	protected function _dispatch(Zend_Controller_Dispatcher_Token $action, $performDispatch)
	{
        ...
        if (!$controller instanceof Zend_Controller_Page) {
           throw new Zend_Controller_Dispatcher_Exception("Controller \"$className\" is not an instance of Zend_Controller_Page.");
        }
            
        /**
         * Dispatch
         *
         * Call the action of the Zend_Controller_Page.  It will return either null or a
