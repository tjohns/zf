...
/** Zend_Controller_Page_Exception */
require_once 'Zend/Controller/Page/Exception.php';
 ...
 * @license    http://www.zend.com/license/framework/1_0.txt Zend Framework License version 1.0
 */
abstract class Zend_Controller_Page
{
    /**
     ...
     * call.  This is set by Zend_Controller_Page::_forward().
     * @var Zend_Controller_Dispatcher_Token
     */
    ...
    /**
     * Any controller extending Zend_Controller_Page must provide an index()
    ...
    public function __call($methodName, $args)
    {
        ...
        throw new Zend_Controller_Page_Exception($msg);
    }
    ...
    {
        if (headers_sent()) {
            throw new Zend_Controller_Page_Exception('Cannot redirect because headers have already been sent.');
        }
