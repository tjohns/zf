...
// remove current directory from include_path
if ($cd = array_search('.', $includePaths = explode(PATH_SEPARATOR, get_include_path()))) {
    unset($includePaths[$cd]);
