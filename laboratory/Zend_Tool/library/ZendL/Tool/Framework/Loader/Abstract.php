...
abstract class ZendL_Tool_Framework_Loader_Abstract
{
    ...
    public function load()
    {
        ...
        $manifestRegistry = ZendL_Tool_Framework_Manifest_Registry::getInstance();
        ...
        foreach ($loadedClasses as $loadedClass) {
            ...
            if ($reflectionClass->implementsInterface('ZendL_Tool_Framework_Manifest_Interface') && !$reflectionClass->isAbstract()) {
                $manifestRegistry->addManifest($reflectionClass->newInstance());
            }
            
            if ($reflectionClass->implementsInterface('ZendL_Tool_Framework_Provider_Interface') && !$reflectionClass->isAbstract()) {
