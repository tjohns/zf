...
class ZendL_Tool_Framework_Manifest_Registry //implements IteratorAggregate 
{
     ...
     *
     * @return ZendL_Tool_Framework_Manifest_Registry
     */
    ...
    public function addManifest(ZendL_Tool_Framework_Manifest_Interface $manifest)
    {
        ...
        foreach ($this->_manifests as $manifest) {
            if (method_exists($manifest, 'getMetadata')) {
                ...
                foreach ($metadatas as $metadata) {
                    if (!$metadata instanceof ZendL_Tool_Framework_Manifest_Metadata) {
                        throw new ZendL_Tool_Framework_Manifest_Exception('A ZendL_Tool_Framework_Manifest_Metadata object was not found in manifest ' . get_class($manifest));
                    }
    ...
    protected function _addMetadata(ZendL_Tool_Framework_Manifest_Metadata $metadata)
    {
