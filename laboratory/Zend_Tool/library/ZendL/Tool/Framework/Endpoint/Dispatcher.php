...
class ZendL_Tool_Framework_Endpoint_Dispatcher
{
    /**
    ...
    public function setRequest(ZendL_Tool_Framework_Endpoint_Request $request)
    {
        $this->_request = $request;
        return $this;
    }
    
    public function setResponse(ZendL_Tool_Framework_Endpoint_Response $response)
    {
    ...
    public function dispatch()
    {
        ...
        $providerSignature = ZendL_Tool_Framework_Provider_Registry::getInstance()->getProviderSignature($this->_request->getProviderName());
        ...
        if (!$actionableMethod = $providerSignature->getActionableMethod($actionName)) {
            ...
            throw new ZendL_Tool_Framework_Endpoint_Exception('Dispatcher error - actionable method not found');         
        }
        ...
        if (method_exists($provider, $methodName)) {
            ...
            require_once 'ZendL/Tool/Framework/Endpoint/Exception.php';
            throw new ZendL_Tool_Framework_Endpoint_Exception('Not a supported method.');
        }
    }
