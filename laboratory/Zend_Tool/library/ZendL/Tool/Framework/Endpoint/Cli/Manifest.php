...
class ZendL_Tool_Framework_Endpoint_Cli_Manifest implements ZendL_Tool_Framework_Manifest_Interface
{
    ...
    public function getMetadata()
    {
        ...
        foreach ($providerRegistry->getActions() as $action) {
            $metadatas[] = new ZendL_Tool_Framework_Manifest_ActionMetadata(array(
        ...
        foreach ($providerRegistry->getProviderSignatures() as $providerSignature) {
            ...
            $metadatas[] = new ZendL_Tool_Framework_Manifest_ProviderMetadata(array(
