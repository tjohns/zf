...
class ZendL_Tool_Project_Provider_Controller extends ZendL_Tool_Project_Provider_Abstract 
{
    ...
    */
    ...
    public function create($name, $viewincluded = true)
    {
        ...
        if ($viewincluded) {
            $viewProvider = ZendL_Tool_Framework_Provider_Registry::getInstance()->getProvider('View');
