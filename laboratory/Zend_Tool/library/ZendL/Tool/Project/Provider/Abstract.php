...
require_once 'ZendL/Tool/Framework/Provider/Interface.php';

abstract class ZendL_Tool_Project_Provider_Abstract implements ZendL_Tool_Framework_Provider_Interface 
{
    ...
    final public function __construct()
    {
        ...
        if (!self::$_builtInClassesLoaded) {
            $this->_loadContextClassesIntoRegistry(array(
                ...
                'ZendL_Tool_Project_Structure_Context_Zf_ControllerFile',
                'ZendL_Tool_Project_Structure_Context_Zf_ControllersDirectory',
                ...
                'ZendL_Tool_Project_Structure_Context_Zf_ViewControllerScriptsDirectory',
                'ZendL_Tool_Project_Structure_Context_Zf_ViewFiltersDirectory',
                'ZendL_Tool_Project_Structure_Context_Zf_ViewHelpersDirectory',
                'ZendL_Tool_Project_Structure_Context_Zf_ViewScriptFile',
                'ZendL_Tool_Project_Structure_Context_Zf_ViewScriptsDirectory',
                'ZendL_Tool_Project_Structure_Context_Zf_ViewsDirectory',
