...
class ZendL_Tool_Project_Structure_Context_Zf_ViewScriptFile extends ZendL_Tool_Project_Structure_Context_Filesystem_File
{
    ...
    public function getContents()
    {
        ...
        if ($this->getFilesystemName() == 'index.phtml') {
            $contents .= 'Hello from the index view script.';
