 ...
 * blah
 */
class ZendL_Reflection_TestSampleClass extends ArrayObject
{
    
}


class ZendL_Reflection_TestSampleClass2 implements IteratorAggregate  
{
    ...
    public function getProp2($param1, ZendL_Reflection_TestSampleClass $param2)
    {
        return $this->_prop2;
    }
 ...
 *
 */
abstract class ZendL_Reflection_TestSampleClass3 extends ArrayObject implements Iterator, Traversable
{


}

interface ZendL_Reflection_TestSampleClassInterface
{
    
}

class ZendL_Reflection_TestSampleClass4 implements ZendL_Reflection_TestSampleClassInterface
{
 ...
 */
class ZendL_Reflection_TestSampleClass5 {
